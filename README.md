...
Integrantes: Dante Mateo Aleman Romano, Jonatan Ariel Acuña Corahua, Fabrizio Alessandro Contreras Peralta, Neil Aldrin Wilhelm Curipaco Hayllani, Ernesto Rodas Sotomayor 
...
| 0.3.3   | 20/04      | Jonatan AcuñaCuripaco NeilFabrizio ContrerasMateo Alemán | Se diseñaron los Mock-ups aplicando las Style Guidelines para representar visualmente los componentes con alta fidelidad, incluyendo botones, formularios y toolbars. Finalmente, se construyeron los User Flow Diagrams, detallando los recorridos de diseñador, cliente y fabricante a través de tareas clave. Este trabajo permitió validar los flujos funcionales y preparar las interfaces para la etapa de prototipado. |
...
| 2.1.0   | 13/05/2025 | Jonatan AcuñaCuripaco NeilFabrizio ContrerasMateo Alemán | Se planificó y ejecutó el Sprint 2 con base en las correcciones y entregables del Sprint 1. Se definieron objetivos específicos y se actualizó el Sprint Backlog 2 con nuevas historias priorizadas por epic y capa funcional. Se asignaron responsables por funcionalidad en la matriz de Aspect Leaders and Collaborators para mejorar la trazabilidad de tareas. Se desarrollaron e implementaron nuevas funcionalidades en la landing page, módulos de diseño y flujos de usuario, generando evidencia de desarrollo y ejecución. Se documentaron los servicios implementados y su integración en el sistema. Además, se desplegaron actualizaciones en entornos de prueba y producción, dejando evidencia técnica y operativa. Finalmente, se recopilaron insights sobre la colaboración del equipo, destacando mejoras en la coordinación, revisión cruzada de tareas y mayor autonomía en la resolución de incidencias. |
| 3.1.1   | 18/062025  | Jonatan Ariel Acuña Corahua                              | Lideró la documentación de endpoints de User Management (UM), participó en la elaboración de la matriz LACX, y facilitó sesiones de planificación y revisión del Sprint. También aportó en el análisis de las entrevistas simuladas orientadas a la experiencia del comprador. |
| 3.1.2   | 18/06/2025 | Dante Mateo Alemán Romano                                | Estuvo a cargo de la documentación del módulo de Access Security (AS) y colaboró en los aspectos de Orders Fulfillment (OF). Participó activamente en las entrevistas simuladas desde la perspectiva del fabricante y revisó técnicamente los endpoints de autenticación. |
| 3.1.3   | 18/06/2025 | Fabrizio Alessandro Contreras Peralta                    | Lideró la documentación de Analytics (AL) y colaboró en el módulo Design Lab (DL), tanto en la redacción de endpoints como en la identificación de mejoras funcionales desde el punto de vista del diseñador. Apoyó en la redacción de criterios de aceptación derivados de entrevistas. |
| 3.1.4   | 18/06/2025 | Neil Aldrin Wilhelm Curipaco Huayllani                   | Colaboró en la documentación de endpoints de Orders Fulfillment (OF) y Product Catalog (PC). Participó activamente en la recopilación y redacción de observaciones funcionales desde la perspectiva del usuario comprador. También contribuyó a traducir los hallazgos de entrevistas en nuevas historias de usuario. |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdxBv17YxdfzhBwiwHqmDjq3uC9cYCPZowpOhOS9t2Nt0lh0e2mTVSSnb9hHw_2Wj28ObRQsUJQT1hpPSsf0-V-UEktoYmWtFb01kvjBd6kjtsG7tgE-vxEykc4N6QNfz1ah4EiWA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcqpkASLbwNXVQI_CUZ7P07wtqloaRZ6hGK807ZoKo7g_H331ycZgP8w0GmNU0cmQ5dDT6pVWAcgnQm6FB26aGBeREX2RoXOB9k-c2ZFxE4LFCJsY95mZfmjTpEysoPQiXWVypn9w?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcvu7ezW7L10w97mhmgZTe6HOvcQbwgiGTK4FvQZAD2gSqrfYvq2DemZkYXR_AW0sul_OqeKuoicQHPEFIG2tA_kJCSESQA8I-YB3TctqJesl4LKHupYxBSOPn_3JmVN5Jo9B0h?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
- **Documentación de Diseño de Interfaz General.** Añadió la documentación de wireframes y mockups para la plataforma Q2, cubriendo el diseño general de la interfaz.
...
- **Establecimiento de Guías de Diseño.** Contribuyó con las guías de estilo y guías web para el diseño de la plataforma Q2, asegurando la cohesión visual y la experiencia de usuario.
...
- **Evaluación de Accesibilidad y Usabilidad.** Amplió la evaluación de accesibilidad y usabilidad para la plataforma Q2, asegurando que el producto sea inclusivo y fácil de usar.
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdI6kD7y5GQpqyRlHlF_A4pLIqSM91SQpD_V4RKCqjOuJJ25YSDQRvqq6KZSmvp8djgFnzirJpxNGldoYrEJGipsN2-FZnPJ_dN8Z3P_53LGIHmwNgjLtsCwfgp_nREIhN5iRzU?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcF5R_oabWs5jNQRjt604AiPTjgK9CejaOX5oan7R-EZWQlWKoGiet5d3Y156AJVGdWBNepdMAEMRkxYXOhX10BN7pV8hQRMH05wqXGJLR_JLcDJjo_MkQgK4K2VNyL8k79y1Tl?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
- **Sección de Conclusiones.** Añadió la sección de conclusiones al README.md, resumiendo el desarrollo del proyecto Q2 - TeeLab y las metodologías aplicadas, lo que proporciona un cierre formal al informe.
...
Durante el Sprint 3, el equipo trabajó de manera coordinada para elaborar las secciones correspondientes del informe del proyecto, basándose en los entregables técnicos y funcionales desarrollados. Las actividades se distribuyeron de acuerdo con los aspectos en los que cada integrante participó activamente durante el sprint, asegurando coherencia entre la ejecución técnica, el registro de versiones y la documentación escrita. A continuación se detallan las contribuciones realizadas:

**Jonatan Ariel Acuña Corahua**

- Documentó la sección **Services Documentation Evidence**, incluyendo la descripción técnica de endpoints y el repositorio de Web Services.

  

- Lideró la redacción del artefacto **Leadership and Collaboration Matrix (LACX)**, detallando los roles por aspecto en Web App y Web Service.

  

- Contribuyó en la redacción de las conclusiones del **Student Outcome 5**, organizando la información de entrevistas y liderazgo.

  

 **Dante Mateo Alemán Romano**

- Participó en la descripción del módulo **Access Security**, incluyendo ejemplos de request/response de los endpoints.

  

- Redactó la descripción de una de las entrevistas simuladas desde la perspectiva del fabricante.

  

 **Fabrizio Alessandro Contreras Peralta**

- Redactó la sección del informe relacionada al módulo **Analytics** y colaboró en el desglose de tareas en el LACX.

  

- Documentó observaciones del editor desde la perspectiva del diseñador en la sección de entrevistas.

  

- Contribuyó en la síntesis de los hallazgos funcionales y en su traducción en historias de usuario y criterios de aceptación.

  

 **Neil Aldrin Wilhelm Curipaco Huayllani**

- Encargado de redactar la sección de hallazgos derivados de entrevistas desde el punto de vista del comprador y manufacturero.

  

- Participó en la elaboración del resumen de resultados de entrevistas, y en la redacción de su conversión a elementos del Product Backlog.
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Jonatan Ariel Acuña Corahua: TB1:Lideró planificación del Sprint 1: definición de objetivos y asignación de historias.• Facilitó daily stand-ups para seguimiento de avances.• Moderó la creación de la matriz LACX (roles Líder/Colaborador). TP1:Coordinó integración del sidebar responsivo y lazy-loaded modules en Vite + PrimeVue.• Condujo retrospectivas ajustando estimaciones y dependencias técnicas.• Planificó la introducción de pruebas end-to-end.Neil Aldrin W. Curipaco Huayllani: TB1:Implementó i18n y accesibilidad (etiquetas ARIA) en pair-programming.• Analizó métricas de commits y PRs, presentando un reporte de participación en GitHub.TP1:Lideró integración de guards de ruta y filtrado de menú por roles.• Supervisó revisiones cruzadas de Pull Requests para mantener la calidad del código.Fabrizio A. Contreras Peralta: TB1:Socializó artefactos UX (User Personas, Empathy Maps) en workshops.• Facilitó la creación de la matriz LACX de Sprint 1, clarificando roles y responsabilidades.TP1: Coordinó diseño y aprobación de wireframes y mockups en PrimeVue.• Gestionó la planificación de pruebas de usabilidad y criterios de aceptación del editor de canvas.Mateo Dante Alemán Romano: TB1: Moderó la definición del Ubiquitous Language en debates de equipo.• Organizó planificación inicial de i18n con Vue + Vite.TP1: Lideró daily retrospectives (velocidad y estimaciones).• Coordinó documentación de despliegue y GitFlow, enseñando convenciones de commits y PRs. |
| Crea un entorno colaborativo einclusivo, establece metas,planifica tareas y cumpleobjetivos. | Jonatan Ariel Acuña Corahua: TB1:Facilitó daily stand-ups donde cada miembro compartió impedimentos y próximos pasos, asegurando seguimiento.• Definió objetivos claros en la planificación del Sprint 1 y desglosó tareas en el backlog.• Moderó la matriz LACX para visibilidad de roles y tareas.TP1:Lideró las retrospectivas, recolectando feedback y replanificando tareas críticas.• Estableció metas de pruebas end-to-end y organizó el cronograma de ejecución.• Coordinó checkpoints técnicos para asegurar cumplimiento de criterios antes de cada entrega.Neil Aldrin W. Curipaco Huayllani: TB1:Implementó sesiones de pair-programming para accesibilidad, integrando a diseñadores y desarrolladores.TP1:Definió checkpoints para evaluar el avance continuamente.Fabrizio A. Contreras Peralta: TB1:Organizó workshops de UX donde todos participaron en la creación de personas y mapas de empatía.TP1:Coordinó la planificación y revisión de mockups en sesiones colaborativas de PrimeVue.Mateo Dante Alemán Romano: TB1:Moderó la definición del Ubiquitous Language en talleres de equipo para alinear conceptos.TP1:Coordinó la documentación de GitFlow y definió tareas de despliegue continuo. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Acciones TB2:Jonatan Ariel Acuña Corahua Coordinó sesiones de planificación del Sprint 3, facilitando una comunicación clara y promoviendo la participación equitativa entre los miembros. Contribuyó a la definición de objetivos realistas, así como a la planificación de tareas en el backlog. Supervisó el cumplimiento de entregables y promovió el respeto entre puntos de vista diversos.Fabrizio Alessandro Contreras Peralta Participó activamente en espacios de codiseño funcional, aportando ideas que promovieron la inclusión de necesidades del usuario diseñador. Ayudó en la revisión de tareas y asignaciones, asegurando balance entre los miembros. Su aporte fue clave para mantener el enfoque del equipo en los objetivos de diseño e interfaz.Dante Mateo Alemán Romano Contribuyó en el refinamiento de historias y planificación de tareas relacionadas con autenticación y roles. Promovió la colaboración en tareas de seguridad, asegurando que todos comprendieran las implicancias técnicas. Participó activamente en las entrevistas simuladas, asegurando pluralidad de perspectivas.Neil Aldrin Wilhelm Curipaco Huayllani  Favoreció la integración de ideas de todos los miembros durante las reuniones, promoviendo un entorno donde se valoró la voz de cada integrante. Ayudó a consolidar hallazgos de entrevistas en metas funcionales claras y alcanzables. |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Jonatan Ariel Acuña Corahua  Asumió el liderazgo técnico en módulos clave del backend (User Management) y en la redacción de artefactos como el LACX. Promovió decisiones consensuadas durante el Sprint, liderando con apertura al feedback del equipo.Fabrizio Alessandro Contreras Peralta  Asumió liderazgo funcional en el módulo de Analytics, proponiendo ajustes para alinear el sistema a métricas útiles para usuarios y fabricantes. Mostró iniciativa en momentos críticos, manteniendo el enfoque grupal.Dante Mateo Alemán Romano  Lideró técnicamente el módulo de Access Security, apoyando a compañeros con menor experiencia en la lógica de autenticación. Su liderazgo fue colaborativo, orientado al aprendizaje grupal y avance conjunto.Neil Aldrin Wilhelm Curipaco Huayllani  Compartió liderazgo en la traducción de hallazgos de usuario en backlog técnico. Su capacidad para escuchar e integrar aportes fue clave para tomar decisiones balanceadas en los aspectos funcionales del proyecto. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Acciones TF:Jonatan Ariel Acuña Corahua: Cumplió sus objetivos relacionados con la seguridad del backend, desde la autenticación hasta las consultas filtradas, demostrando su capacidad para establecer metas claras y asegurar su implementación.Dante Mateo Aleman Romano: Alcanzó sus objetivos de mejorar la experiencia del cliente en el frontend, destacando su contribución en la visualización del resumen de pedidos y la integración de la funcionalidad de internacionalización.Fabrizio Alessandro Contreras Peralta: Logró sus metas en la optimización del flujo de compra, asegurando que la creación de pedidos pendientes, la validación de envíos y la confirmación final del pedido se implementaran de manera robusta.Neil Aldrin Wilhelm Curipaco Huayllani: Cumplió sus objetivos al implementar las funcionalidades de notificación post-compra y confirmación de pedidos, contribuyendo significativamente a la comunicación con el cliente después de la compra. |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Acciones del TF <br />Jonatan Ariel Acuña Corahua:  <br />Jonatan demostró liderazgo al ser el motor principal del backend, guiando la implementación de la autenticación segura y las rutas protegidas. Su experiencia técnica y su capacidad para configurar pagos y coordinar lanzamientos mostraron un liderazgo de facto en la dirección de la arquitectura de la Web Service.Dante Mateo Aleman Romano:  Dante ejerció liderazgo al guiar la configuración de APIs y la internacionalización, piezas fundamentales para la expansión y adaptabilidad de la aplicación. Su coordinación del lanzamiento de la versión 3.0.0 y su refactorización de lógica de productos y pedidos evidenciaron una visión integral y liderazgo en la cohesión del frontend con el backend.Fabrizio Alessandro Contreras Peralta:  Fabrizio lideró con su enfoque en la refactorización y optimización del flujo de pedidos y las validaciones en el checkout. Su contribución significativa en una sola integración demuestra una capacidad para tomar la iniciativa y asegurar la calidad en un área crítica del negocio.Neil Aldrin Wilhelm Curipaco Huayllani:  Neil tomó la delantera en la refactorización del diseño y el canvas, así como en la mejora de la navegación y las funcionalidades de autenticación y carrito. Su visión para la experiencia del usuario y su capacidad para consolidar funcionalidades del backend reflejaron un liderazgo técnico y de diseño. |
...
Más que facilitar la creación de camisetas, en Teelab by Q2 impulsamos que cada persona lleve su identidad puesta. Queremos ser el punto de encuentro de una comunidad que celebra las ideas únicas, que valora la creatividad y que entiende que la moda también puede ser una herramienta de cambio positivo.

### 1.1.2. Perfiles de integrantes del equipo

1. 

| Soy estudiante de Ingeniería de Software en UPC, con 19 años y en el quinto ciclo. Apasionado por tecnología y videojuegos, busco proyectos innovadores con impacto positivo. Con habilidades colaborativas, aspiro a contribuir y aprender en equipo, enfrentando objetivos y desafíos tecnológicos con determinación. | ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdPWvYUasJO2wU1vJyk6L2cMpmN3_5FlECWymXrKudwN7mW_4wXuTZpNpz46vVu-mVJpm8uo25UaGgAPs5F93RZ8ML1ZWXHkJzQuk7NPqYT-R4pGDe44epT8g0KjK_NQlCZ6d8e?key=J06Wc8-GfXXlOJgmuX32uwpk) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| Alumno: Contreras Peralta, Fabrizio AlessandroCódigo: U202319889Carrera: Ingeniería de Software |                                                              |
| Soy Fabrizio Contreras tengo 20 años y actualmente soy estudiante de la carrera de Ingeniería de Software en la UPC. Me considero una persona tanto creativa como resiliente. Siento gran pasión por el mundo tecnológico. Domino aspectos de UX/UI.Busco pertenecer a proyectos innovadores y de gran incidencia. | ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc6KyDSbAeYwFDb7jBejLsXM14Jr_tGsxIS9YoeaxCoX0yFSgGyHP2B6cQVIPBvN4AorhT1u4Nv0Kas7XcAixKlfTN8gelVIEt69mcT7u06U5Jc4kBsK4ZlffnCN7_Ef4ErC66V?key=J06Wc8-GfXXlOJgmuX32uwpk) |
| Alumno: Acuña Corahua, Jonatan Ariel Código: u20211b995 Carrera: Ingeniería de software |                                                              |
| Soy estudiante del 5to ciclo de la carrera de Ingeniería de Software en la UPC. Me gustó la carrera tras aprender desarrollo web y desde entonces, sigo aprendiendo para mejorar mis habilidades cada vez más. Me gusta aprender sobre las nuevas tecnologías de la web, jugar videojuegos y de vez en cuando salir en bicicleta. | ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcVluzmOLVgktsBsloveWOcrOuqkTyCV_s7b0YkZ3ClwXp9yt2KViqjvJ_AzgtMQU0Mavz-MUtgKEfLZc8fcW2O5-boDz6QshSulfauOaelG_GqBXNTUupuX30MT6_kdpDtnqtQag?key=J06Wc8-GfXXlOJgmuX32uwpk) |
| Alumno: Curipaco Huayllani, Neil Aldrin Wilhelm Código: u20231b866Carrera: Ingeniería de Software |                                                              |
| Soy Neil Curipaco Huayllani. Estoy cursando el 4to ciclo de la carrera de Ingeniería de Software en la UPC. Me gusta jugar videojuegos, aprender cosas nuevas, escuchar música y mejorar mis habilidades para ser de ayuda en el equipo de trabajo del que formo parte. | ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc4MqPqSBF38ikf4vq7CEHm0GXauCVadVKe_TPQFkqCewidddSHqrYSU20hO0m3PuWW8gaHwq8riu39t-5Tjh0i8LwIYGWLIzdS2mX9nZT8aOQBcGYXsfNZMd_19z7srfpN5GwW4w?key=J06Wc8-GfXXlOJgmuX32uwpk) |
| Alumno: Rodas Sotomayor, ErnestoCódigo: u202312443Carrera: Ingeniería de Software |                                                              |
| Soy Ernesto Rodas. Actualmente curso el 5to ciclo de la carrera de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas (UPC). Me apasiona la programación, el diseño de aplicaciones web y el trabajo en equipo. Disfruto enfrentar nuevos retos, aprender constantemente y aportar con soluciones prácticas en los proyectos donde participo. | ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeguOtJFu2FGvTPiICWa4z7hgyzOf1lasj-aEhzHnkJxi40ZqpYNYJf9INNlZrhX7h1bXXGsuLzC-3L0c-cEqHM1AO-HcJTg-6VRj3re06KOi-yHt_lKWB-jXd2qNXOq8wktJsx?key=J06Wc8-GfXXlOJgmuX32uwpk) |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXddhUUso5sgexmcu-LAvDph5_yKiTSFjer2W29W4v3iI7bGIqsNJCks_aTM6MrW-_tC_IRXvi0NwutBQ6csDviYOtWuXPwdS7aFobTQ1sbSYEjQpfIUr9EaZj6AVwwqruAL3XyIAw?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
En esta sección vamos a identificar la información que necesitamos obtener desde los segmentos objetivos previamente trazados. Para la información básica del entrevistado se usará un formulario básico a través del siguiente enlace: **https://shre.ink/x5d6**
...
| **Resumen:** <br /> Grecia Curipaco Huayllani, es diseñadora. Aunque actualmente no vende sus diseños, los publica en Behance e Instagram. Está interesada en poder vender sus diseños en camisetas y cree que es vital tener un sistema interactivo y fácil de usar donde los usuarios no solo puedan ver, sino también editar los diseños. Además, aprecia que estos diseños se muestren en maquetas para que los compradores tengan una idea clara de lo que recibirán. Está dispuesta a aceptar pedidos de diseños personalizados porque valora trabajos inusuales y únicos.<br /><br />En cuanto a sus preferencias, menciona que las marcas de camisetas que más le agradan son Gildan y Fruit of the Loom por su calidad y comodidad. Para diseñar, utiliza principalmente una laptop con pantalla gráfica, lo cual le facilita el proceso creativo. Sus programas de edición favoritos son Adobe Illustrator y Photoshop, herramientas que considera esenciales para el nivel de detalle que requiere en sus trabajos. Finalmente, señala que se mantiene informada sobre tendencias de moda y novedades principalmente a través de redes sociales como Instagram y Pinterest, además de seguir sitios especializados en diseño y moda como Vogue y Behance.<br />**Datos adicionales:** <br />**Marcas de camisetas preferidas:** Gildan y Fruit of the Loom.<br /> **Dispositivos usados para diseñar:** Laptop de marca Lenovo con sistema operativo Windows 10 y smartphone android. <br />**Programas de edición utilizados:** Adobe Illustrator y Photoshop. <br />**Canales de información sobre tendencias:** Instagram, Pinterest, Vogue y Behance. <br />**Motivations:** Vender sus diseños en productos físicos (como camisetas), mostrar sus diseños en maquetas realistas, tener una plataforma fácil de usar y recibir pedidos personalizados. |                                       |
| **Frustrations:** No tener una plataforma interactiva y accesible donde sus diseños sean mostrados de manera atractiva; limitaciones actuales de exposición en redes.<br />**Entrevista 2:** Angela Galdez |                                       |
| **Browsers: ** Instagram, Facebook, YouTube, LinkedIn, Pinterest.<br />**Sexo:** Femenino | **Edad:** 23 años                     |
| **Devices:** Laptop de marca Lenovo con sistema operativo Windows 10 y smartphone android.**Instante en el que inicia:** 4 minutos y 19 segundos | **Duración:** 4 minutos y 12 segundos |
...
| **Resumen:** Daniela Gómez, manifestó haber adquirido camisetas con diseños en ocasiones especiales como conciertos y ferias. Le gustaría poder diseñar y reflejar mejor su estilo y cree que es genial estar en la posibilidad de editar los diseños. Hizo énfasis en la calidad del material, ya que en el pasado ha tenido malas experiencias con telas de baja calidad, por lo que pagaría entre 50 y 80 soles por una camiseta que posea una excelente durabilidad y apariencia. Aunque considera importante la rapidez en la entrega, no le incomoda un pequeño retraso.En cuanto a sus preferencias personales, Daniela suele utilizar una laptop para navegar y realizar compras. Entre sus redes sociales favoritas se encuentran Instagram y TikTok, que también usa como fuentes de inspiración. Para mantenerse al tanto de las tendencias de moda y novedades en camisetas, recurre principalmente a Instagram, Pinterest y ocasionalmente a revistas de moda digitales como Vogue y Elle.  <br />**Datos adicionales:****Marcas de camisetas preferidas:** No especifica, pero prioriza la calidad del material.<br />**Dispositivos usados para diseñar o comprar:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**Programas de edición utilizados:** No mencionó programas específicos, pero se mostró interesada en herramientas de edición dentro de la plataforma.<br />**Canales de información sobre tendencias:** Instagram, Pinterest, Vogue, Elle.<br />**Motivations:** Reflejar su estilo personal en el diseño, asegurar calidad en el material, tener camisetas duraderas.<br />**Frustrations:** Malas experiencias pasadas con telas de baja calidad; poca flexibilidad en la edición de diseños.<br />**Browsers:** Instagram, Pinterest, TikTok, Facebook, WhatsApp.<br />**Devices:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android. |                                       |
...
| ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdnJpgeY7RZXX7GaE_2QY2P5DMnnR9qXH_eC52ZpKQTFSQq2wgba450U1jGtgnOj0gbi3De8DEhVwS9rHnR-c508dmvoFtvTTuflHd-4Z0gjRIbL8AHAQkowAOwOSuTutXGihWwYw?key=wLsuErVgqDz-qczrBI4kMctR) |                                       |
| **Resumen:**Giuliana Nisbeth, señala que cualquier persona puede encargar camisetas personalizadas, ya sean para eventos como campeonatos o instituciones. La mayor parte de los encargos se basa en diseños ya existentes o fotos que se encuentran en Internet. Aunque aceptan tanto diseños externos como propios preestablecidos, se complican cuando los clientes realizan cambios a los últimos detalles sobre el diseño o la cantidad, lo que retrasa los plazos de entrega. Los pedidos actualmente se hacen mayormente por medio de Instagram o WhatsApp.Respecto a sus herramientas y hábitos de trabajo, Giuliana suele utilizar una **laptop** para gestionar pedidos y diseñar. Para mantenerse actualizada sobre tendencias de moda y novedades en camisetas, consulta principalmente **Instagram**, páginas especializadas en moda y plataformas de diseño como **Behance**. Utiliza **Adobe Illustrator** y **Photoshop** como programas de edición, ya que le permiten manejar con precisión los detalles que sus clientes solicitan. **Tipo de clientes:** Personas naturales, instituciones educativas, empresas deportivas (campeonatos y eventos especiales).<br />**Principales desafíos:** Cambios de último momento en el diseño o la cantidad, afectando los tiempos de entrega.<br />**Dispositivos usados:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**Programas de edición utilizados:** Adobe Illustrator y Photoshop.<br />**Canales de información sobre tendencias:** Instagram, Behance, páginas especializadas en moda. **Motivations:**** ** Cumplir pedidos personalizados de clientes variados (eventos, instituciones) de forma eficiente; aceptar tanto diseños propios como externos.<br />**Frustrations:*** Cambios de último momento en diseños o cantidades por parte de los clientes, lo que causa retrasos.<br />**Browsers:** Instagram, WhatsApp, Facebook, YouTube, LinkedIn.<br />**Devices:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android. |                                       |
...
| ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeD3lODGZtgcvZYNbsvXJWIGNiEhsEYyj9eTwvwkbdIKAKPTH07uH-17YLZ7TH1ACN44sR-oSLcMPTQAI956eP1NOPY-8_oDTqUusJ0K89T6IW8xXxuN8dbK_FdpYJtOu_RwgIm?key=wLsuErVgqDz-qczrBI4kMctR) |                                       |
| **Resumen:**<br />Lenny Torres, afirma que sus clientes principales incluyen tanto instituciones deportivas privadas como públicas, así como varios otros tipos de clubes. Señala la necesidad de satisfacer una gran demanda de camisetas en un corto período de tiempo como el desafío más importante. Su servicio ofrece diseños personalizados, así como la opción de utilizar diseños proporcionados por los clientes, y actualmente gestionan los pedidos a través de procesos predefinidos.Respecto a sus herramientas de trabajo, Lenny utiliza una **computadora de escritorio** para coordinar la gestión de pedidos y preparar los diseños. Para estar actualizado en cuanto a tendencias de moda y novedades sobre camisetas, recurre principalmente a **Instagram**, **YouTube** y **sitios especializados** en moda deportiva. Para el diseño y edición de los artes finales, emplea **CorelDRAW** y **Adobe Illustrator**, programas que considera eficientes para el flujo de trabajo rápido que su producción requiere.  <br />**Datos adicionales:****Tipo de clientes:** Instituciones deportivas públicas y privadas, clubes.<br />**Principales desafíos:** Atender pedidos grandes en plazos cortos.<br />**Dispositivos usados:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**Programas de edición utilizados:** CorelDRAW y Adobe Illustrator.<br />**Canales de información sobre tendencias:** Instagram, YouTube, páginas especializadas en moda deportiva.<br />**Motivations:*** Atender grandes volúmenes de pedidos en tiempos cortos, ofrecer flexibilidad entre diseños personalizados y predefinidos.<br />**Frustrations:**  Presión de tiempos de entrega por alta demanda, complejidad en la producción masiva.<br />**Browsers:** Instagram, WhatsApp, Facebook, YouTube, LinkedIn.<br />**Devices:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android. |                                       |
...
| ----------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Segmento #1: Diseñadores            | **- Sexo:** Femenino.<br />**- Edad:** 23-24 años. Dispositivos: **-** Laptop con pantalla gráfica.<br /> **- Dispositivos:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**- Programas:** Adobe Illustrator y Photoshop, Procreate.<br />**- Canales de información:** Instagram, Pinterest, Behance, Dribbble.<br /> **- Canales de venta y exposición:** Instagram, WhatsApp, Facebook, YouTube, LinkedIn. <br />**- Marcas preferidas:** Gildan, Fruit of the Loom. | **- Motivación:** Vender diseños, llegar a más público, tener plataforma interactiva y fácil de usar, mostrar diseños en maquetas, recibir pedidos personalizados, recibir calificaciones. **- Frustración:** Falta de plataformas interactivas con buena exposición visual y flexibilidad para acuerdos personalizados. |
| Segmento #2: Usuario General        | **- Sexo:** Femenino.<br />**- Edad:** 22 años.<br />**- Dispositivos:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**- Canales de información:** Instagram, Pinterest, TikTok, Facebook, WhatsApp.**<br />- Canales de compra:** Plataformas con herramientas de edición.<br /> **- Marcas preferidas:** Priorizan la calidad del material. | **- Motivación:** Crear diseño propio, tener control sobre el diseño, asegurar calidad del material, reflejar estilo personal. **- Frustración:** Comprar diseños que no son de su agrado, poca flexibilidad para personalizar, malas experiencias con calidad de tela. Disposición a pagar más por calidad. |
| Segmento #3: Marcas o Emprendedores | **- Sexo:** Femenino.<br />**- Edad:** 20-28 años.<br />**- Dispositivos:** Laptop de marca Hp con sistema operativo Windows 10 y smartphone android.<br />**- Programas:** Adobe Illustrator, Photoshop, CorelDRAW.<br />**- Canales de gestión y ventas:** Instagram, WhatsApp.<br />**- Canales de información:** Instagram, WhatsApp, Facebook, YouTube, LinkedIn.<br />**- Tipo de clientes:** Personas naturales, instituciones educativas o deportivas, clubes. | **- Motivación:** Cumplir pedidos personalizados de clientes variados, atender alta demanda, ofrecer flexibilidad, gestionar pedidos eficientemente.- **Frustración:** Cambios de último momento en diseño y/o cantidad, presión por plazos de entrega cortos en alta demanda. |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfj1uIAST8lMf_RKY6MYmj1yTjZRGe6y6LfZf_yz1fDFLrdTA1_jhXF_AM4Rs6p1UZd0XAwnEsPYmXvhDxVSL47QDaRJGYFBr2CDkpjEjhTByIT4hQeXz6FHva3L74-dZuQ4g8P?key=wLsuErVgqDz-qczrBI4kMctR)

- Segmento Objetivo #2: Clientes Individuales Creativos

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdwwvg05k08KM97xZgGALZKc_GupGxeqU7bBXCaw7vjdWWZ3yveEZEv7lgghmsopLJujHwOkk1zAQmP7684FZ56Aj6aL9Vl_WfRJa4nqsfEYI3pvqBC49RVN9wjfaIUHZyZiloQ?key=wLsuErVgqDz-qczrBI4kMctR)

- Segmento Objetivo #3: Marcas Emergentes y Emprendedores

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeWWZx9AmEPZAvKGe6M0q5t6JR1zPnlFs4YgJYqk2rPGipN9sVUM3N0yOv-dZFn2XVQtamleNdSTzziL2jwdDo8PqeRpel4d8eE416r78wC7uaNjgIFy4_9ZleA-1EGKJShEPfs?key=wLsuErVgqDz-qczrBI4kMctR)
...
| N°1  | Task Matrix                                                | Elena Soler | Elena Soler | Marta Lopez | Marta Lopez | Laura Martinez | Laura Martinez |
| ---- | ---------------------------------------------------------- | ----------- | ----------- | ----------- | ----------- | -------------- | -------------- |
|      |                                                            | Frecuency   | Importance  | Frecuency   | Importance  | Frecuency      | Importance     |
| 1    | Explorar la landing page y conocer la plataforma           | Often       | High        | Sometimes   | High        | Often          | High           |
| 2    | Buscar polos personalizados para comprar                   | Sometimes   | Medium      | Sometimes   | Medium      | Sometimes      | Medium         |
| 3    | Diseñar un polo desde cero                                 | Sometimes   | High        | Sometimes   | High        | Often          | High           |
| 4    | Compartir un diseño propio a la plataforma                 | Often       | Medium      | Sometimes   | Medium      | Often          | High           |
| 5    | Seleccionar una plantilla de diseño                        | Often       | High        | Sometimes   | High        | Often          | High           |
| 6    | Agregar un producto al carrito                             | Sometimes   | Medium      | Often       | Medium      | Sometimes      | High           |
| 7    | Realizar un pedido y confirmarlo                           | Often       | High        | Sometimes   | Medium      | Often          | High           |
| 8    | Revisar el estado de un pedido                             | Often       | High        | Often       | High        | Often          | High           |
| 9    | Consultar precios o condiciones de pago                    | Often       | High        | Often       | Medium      | Often          | High           |
| 10   | Dejar una opinión sobre un diseño                          | Sometimes   | Medium      | Sometimes   | High        | Sometimes      | Medium         |
| 11   | Comparar diferentes modelos o estilos de polos             | Often       | High        | Often       | Medium      | Often          | High           |
| 12   | Saber qué diferencias hay entre las calidades de los polos | Often       | High        | Often       | Medium      | Often          | High           |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeO2mN2QovrfWf1lBaOXBF2P93owp2HKoACZAoCEYeHdktwCczatNutHkZK_6G9fm5i5mZn86oHOuyUG1G2xAnCmGK8BwhJC2vQNNdxfYjhSm8rQKJNMDb5C_DoDEAV8RAOzvJn?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #2: Clientes Individuales Creativos

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfBjllzx0Uz3U3UwLvQd8QKw3tYnDAN7uMo8NTNWrS5lkYll_KjMoQ82T1gOYsBH7y1FoBv8_mWrrDUvzrAW_2UxymisYqKPTPEpwz7SKhhdoqzzS2gL7OpSvXXBHhZ2VRsCQ1Ktw?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #3: Marcas Emergentes y Emprendedores

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdyyZG-yKDUA8-eTAisvirNB5iUqcpRTTQ0ujOak1w03elzAxwpKQf0NK-FwtpjOU6Ao60Xm8MAjL3AyiC0tKThklCukKvNhuoRXlYRXuaLZNU-1HB7ztQGjwEs0DDkibWyo-WByA?key=wLsuErVgqDz-qczrBI4kMctR)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcwEoWDALyjdUnm1bYmE_9yBunLZBhziD94ZTbpBtljbeC5KDdecb9zNa9BCvkS4wp_EuwPWdPrb3ktK6JRdDEWecdicG8aW-UrYzaIS1oL8v71vS0Ajn5hHLYZDqo4SN-lERGy5Q?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #2: Clientes Individuales Creativos

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcaeXhu7JxS5uVFJFgjWxtr2rC6TZwx76lSIiqqS_kePXK_EYgpeqrq-7LG3dypfgNodArVBE9TotRo2W0frEikDhxUPF-qyonPFK3iSu2EMSoR8TnMTKuetrN8N1xohrWG4T8J-A?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #3: Marcas Emergentes y Emprendedores

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcja9uDZrWhZrgCUe93qBHTmLAErvs4vyMoIFVxkzabr__EZs9vQgHjnqywd3lhNKDqnLzA9Te3qm8hO_NOrDiKJu2WN-5C4bcwXbghuXLvmL2dzxn8Wqo2O-ID_teMrUPyllMxFw?key=wLsuErVgqDz-qczrBI4kMctR)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfxyQCCzqiVDGS1s9RYKzYf19mb0dgUTcjfTYQpXRjhAxFbh6bx-ex_StDq-mDY1zNKXtwm2dBIFFf9VcTZhXOXvw7cHaQkxlGSOI5Rwmnt0W15-EaiTcWxRxy1ntnqWps3mGAB3Q?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #2: Clientes Individuales Creativos

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcdZyuxSYX-8jRZ5d9h4v9u1sydlQDGKAFD4H2Lu7JC7gIr8uTSiFtlO2yPDTv2Q-WZKmMaYDTI3LhJYx-T_iimizLSiKCt6gUjaGeDRz5TBM40xsYqGGnIZhv1djyH6OVrGJ2n-A?key=wLsuErVgqDz-qczrBI4kMctR)
...
El mapa se organizó en cinco dimensiones clave:

\- Phases: Fases o pasos estructurados del nuevo proceso propuesto.

\- Doing: Acciones que el usuario realizaría en cada fase.

\- Thinking: Pensamientos asociados a cada paso.

\- Saying: Expresiones verbales o intenciones que el usuario podría comunicar.

\- Feeling: Emociones resultantes de cada interacción o fase.

El escenario propuesto integra un conjunto de funcionalidades diseñadas para atender las necesidades específicas de los tres segmentos objetivo identificados: usuarios individuales creativos, diseñadores independientes y emprendedores o pequeñas marcas. Entre las mejoras incorporadas se encuentran: acceso simplificado a la plataforma, edición visual con plantillas predefinidas, previsualización en tiempo real con renderizado 3D, cotización automática y transparente, procesamiento de pedidos automatizado, seguimiento de producción en línea, entregas personalizadas, y gestión postventa integrada.

Estas funcionalidades permiten que los usuarios experimenten una interacción más fluida, autónoma y confiable, resolviendo los principales puntos de fricción detectados en los As-is Scenario Maps y generando valor funcional y emocional en cada etapa del proceso. Además, se garantiza una mayor trazabilidad, ahorro de tiempo operativo y una mejor percepción de control y personalización en cada segmento.

El To-be Scenario Mapping fue validado en una sesión de Playback con el equipo de diseño y múltiples usuarios representativos de los segmentos, permitiendo contrastar los nuevos flujos con la experiencia actual. Las reacciones observadas reflejaron una aceptación emocional positiva, confirmando que el flujo futuro no solo responde a los requerimientos funcionales, sino que se alinea con las motivaciones, expectativas y objetivos de experiencia identificados durante las fases de empatía, ideación y análisis de requisitos.
“Anexo: Diagrama As is Scenario Mapping” :https://acortar.link/c0uFoZ

Segmento Objetivo #1: Diseñadores Gráficos Independientes

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcVZX9o8ZNfhheV1oEAM7RBe1_dwplN8UO8zEhzbvP0Yqg1qa1FWlbtSs-AU26Apdad4-YtAKZpNCyjADQS-Ff9klhpYfALDQwH42bQVEj_SGrs0xS0iLGomsa45fhn71Z2lWbcdw?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #2: Clientes Individuales Creativos

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeNDEgaghnjdpea5PHGfvi1d9taIMbhlaohkNYOrMldnp3hBkmLeUIwJLJCPZfM7wuK_6xByhEtKMxjT5MiMSs9eEIl2x3u9QpFiA4q0vdlpPURO0PVw7QJKItoYGK0m_m5mnaBOg?key=wLsuErVgqDz-qczrBI4kMctR)

Segmento Objetivo #3: Marcas Emergentes y Emprendedores

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcucfryU62LVAdnODzZoOGwPzinF-B3Mjv1VPWToHPjt_yNgRfn89-35wmLbQcu612NvBaub2TxHD7kLp_mUk0YM_Xb4Mk_RrH5HlXWuiRv_RwTsvAeQoOEORfIpegBNXgesIWQ?key=wLsuErVgqDz-qczrBI4kMctR)

## 3.2. User Stories

Para el desarrollo de la plataforma "Q2 – TeeLab", se seleccionaron trece épicas fundamentales que cubren el ciclo de vida completo de interacción del usuario, desde la llegada al sistema hasta la producción, compra y gestión de camisetas personalizadas. Estas épicas fueron definidas estratégicamente bajo el enfoque de *Domain-Driven Design*, delimitando *bounded contexts* funcionales que permiten independencia, escalabilidad y claridad de responsabilidades entre dominios.
...
Las user stories fueron elaboradas aplicando los principios de arquitectura hexagonal, diseño de experiencia de usuario (UX) y arquitectura REST para servicios distribuidos. Cada historia está compuesta por una versión funcional (orientada al usuario final) y una versión técnica (orientada al desarrollador o arquitecto), siguiendo este patrón:

- Funcional: Define qué desea lograr el usuario, por qué, y cómo se relaciona con su rol.
- Técnica: Detalla cómo debe implementarse la funcionalidad, considerando componentes de frontend (Vue), backend (Spring Boot REST), o interoperabilidad (API RESTful, base de datos, etc.).

Se usaron criterios como: consistencia semántica, trazabilidad, claridad de propósito y separación de preocupaciones.

| **Story ID** | **Title**                                                    | **Description**                                              | **Acceptance Criteria**                                      | **Epic** | **Story Points** | **Type**   |
| ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- | ---------------- | ---------- |
| US01         | Change landing page language                                 | As a visitor, I want to translate the landing page, so that I can read the content in my preferred language. | Feature: Translation Scenario: Translate contentGiven I want to translate the landing pageWhen the language is changedThen all content is translatedAnd the change remains consistent | 1        | 3                | Functional |
| US02         | Multidevice Support                                          | As a visitor, I want to be able to view the landing page on my mobile device, so that I do not have the need to open the website on a desktop-like device. | Feature: Responsive Design Scenario: Adaptable layoutGiven I am using a mobile deviceWhen I open the landing pageThen the website displays an adapted versionAnd this change remains consistent Scenario: Landscape ModeGiven I am using my mobile device in landscape orientationWhen I open the landing pageThen the layout adjusts to landscape mode without breaking the contentAnd without corrupting the design | 1        | 3                | Functional |
| US03         | Practical Design Lab interaction                             | As a visitor, I want to access the Design Lab directly from the homepage so that I can interact with the product. | Feature: Access Design Lab Scenario: Redirect to Design LabGiven I want to interact with the platform's core productWhen I initially sign up or sign inThen I am redirected to the Design LabAnd I am able to interact with the product Scenario: Redirect to Design Lab in mobileGiven I want to interact with the platform's core product on a mobile deviceWhen I initially sign up or sign in on my mobile deviceThen I am redirected to the mobile-adapted version of the Design LabAnd I am able to interact with the product | 1        | 3                | Functional |
| US04         | Accessible Navigation                                        | As a visitor who relies on assistive technologies, I want the landing page to clearly announce section roles and labels so that I can understand the structure and purpose. | Feature: ARIA Accessibility Integration Scenario: Hearing descriptive labelsGiven I rely on a screen reader to navigate websitesWhen I use keyboard navigation to move through the landing pageThen proper ARIA roles for each section are announced Scenario: Landmarks navigationGiven I use a screen reader with navigation enabledWhen I move through the page using landmarks or shortcutsThen I am able to skip to key sections | 1        | 3                | Functional |
| US05         | Access Image Descriptions                                    | As a visitor who relies on a screen reader, I want all meaningful images on the landing page to include clear alternative text so that I can understand the visual content and navigate the website. | Feature: Image Accessibility Scenario: Integrate Alt TextGiven I am using a screen readerWhen navigating to an image that conveys informationThen a clear description of the image is announced | 1        | 3                | Functional |
| US06         | Explore Social Media                                         | As a visitor, I want to see links to the official social media accounts so that I can follow updates, stay informed, and/or contact the team. | Feature: Social Media Scenario: Display social mediaGiven I want to contact or follow the start-upWhen I navigate to contact or socialsThen the start-up social media connections are availableAnd are up to date | 1        | 3                | Functional |
| US07         | Display visual representations of the product                | As a visitor, I want to see visual examples of how the product works so that I can feel confident about the product. | Feature: Display Product Functionality Scenario: Display Product Designs made in the Design LabGiven I want to visualize how the product worksWhen I am on the landing pageThen I visualize products made in the platform | 1        | 3                | Functional |
| US08         | Role-Based Rendering of Navigation and Actions               | As a developer, I want to render navigation elements based on the authenticated roles, so that users only see the sections and actions they are authorized to access. | Feature: Role-Based Navigation Scenario: Only role-allowed actionsGiven a user is authenticated with a roleWhen the web application is renderedThen only actions configured for that role are visibleAnd restricted actions are not present Scenario: Unauthorized routes are protectedGiven a user is authenticated with a roleWhen navigating to a route not permitted for their roleThen they are redirected to different viewAnd not able to access | 2        | 5                | Technical  |
| US09         | Text Manipulation in Project                                 | As a designer, I want to manipulate text(s) in a project so that I can personalize the project with a message, branding, etc. | Feature: Text Element in the Design Lab Scenario: Add text element to the canvasGiven I am using the Design LabWhen I add a text elementThen a new text element appears on the canvas Scenario: Change font size, color, and styleGiven I want to customize text elementsWhen I add a text elementThen text modifications are availableAnd the style modifications are applied to the element Scenario: Move text elementGiven a text element is on the canvasWhen the text is movedThen the text element moves to a new intended positionAnd it stays in the new position Scenario: Delete text element from the canvasGiven a text element is selectedWhen deletedThen the text element is removed from the canvasAnd it is no longer part of the current design Scenario: Save design with layersGiven I have one or more elements added to the canvasWhen I save the projectThen the current design, including all elements, is saved | 2        | 8                | Functional |
| US10         | Image Manipulation in Project                                | As a designer, I want to manipulate image(s) in a project so that I can personalize the design. | Feature: Image Element in the Design Lab Scenario: Add image to the canvasGiven I am using the Design LabWhen I add an image from my deviceThen a new image element appears on the canvas Scenario: Move image elementGiven an image element is on the canvasWhen I move the imageThen the image moves to a new intended positionAnd it remains in that position when I release the drag Scenario: Resize image elementGiven an image element is selectedWhen I drag a cornerThen the image element resizes proportionally or freely Scenario: Delete image element from the canvasWhen I delete the image elementThen the image element is removed from the canvasAnd it is no longer part of the current design Scenario: Save design with layersGiven I have one or more elements added to the canvasWhen I save the projectThen the current design, including all elements, is saved | 2        | 8                | Functional |
| US11         | Project Base Color Modification                              | As a designer, I want to modify the base color of the project so that I can personalize the design. | Feature: Modify Base Color of the Project Scenario: Modify base color for the projectGiven I am in the Design LabWhen I select a project colorThen the color of the project changesAnd the change remains consistent in the Design Lab Scenario: Save design with modified base colorGiven I have modified the base color of a projectWhen I save the projectThen the current design color is saved | 2        | 8                | Functional |
| US12         | Layer Ordering Control in the Design Lab                     | As a designer, I need the ability to reorder visual elements on the canvas by moving them forward or backward, so that I can have a better editing experience. | Feature: Layer Ordering Control in the Design Lab Scenario: Bring element forwardGiven I have multiple elements on the canvasWhen I bring an element to the frontThen the selected element moves higher in the layer stackAnd the canvas reflects the new order Scenario: Send element backwardGiven I have multiple elements on the canvasWhen I send an element to the backThen the selected element moves lower in the layer stackAnd the canvas reflects the new order | 2        | 5                | Functional |
| US13         | Real-Time Canvas Rendering and State Reflection              | As a developer, I want the Design Lab canvas to render all user interactions in real time, so that designers receive instant visual feedback and the rendered state accurately reflects what will be saved. | Feature: Canvas Rendering and State Reflection Scenario: Immediately render newly added elementsGiven the user adds a new text or image element in the Design LabWhen the element is createdThen it is rendered on the canvas instantly without requiring a manual refresh Scenario: Apply visual changes live on style updatesGiven the user modifies a selected element’s propertiesWhen the styling configuration is changedThen the canvas re-renders the element immediately to reflect the update Scenario: Remove elements from the canvas upon deletionGiven the user deletes an elementThen the element is removed from the internal design stateAnd it is removed from the rendered canvas Scenario: Save reflects the current visual canvas stateGiven the user saves the projectWhen the system serializes the design stateThen all element properties match what is currently renderedAnd there is no divergence between the saved data and the canvas output | 2        | 8                | Technical  |
| US14         | Add Name and Description to Project                          | As a designer, I want to assign a name and write a short description for each of my product designs so that I can give them identity, meaning, and/or context. | Feature: Add Name and Description Scenario: Assign a name to my product designGiven I am working in the Design LabWhen I enter a name for my projectThen the name is saved as part of my projectAnd the change is reflected in all instances of my project Scenario: Write a description for my product designGiven I am editing my product design in the Design LabWhen I type a description in the input fieldThen the description is saved as part of my projectAnd the change is reflected in all instances of my project | 2        | 3                | Functional |
| US15         | Select Gender and Sizes for Project                          | As a designer, I want to select the gender and available size(s) for my project so that it appears correctly in customer filters and size selections, and also, so that manufacturers can handle sizing more accurately during production. | Feature: Gender and Sizes for Product Design Scenario: Select gender for my product designGiven I am in the Design LabWhen I add a gender specification to my projectThen the selected gender is saved with the designAnd it appears correctly in customer-facing filters Scenario: Select available sizes for my product designGiven I am in the Design LabWhen I add sizing preferenceThen the size(s) are saved with the designAnd they are displayed as available options for customers Scenario: Manufacturing accuracyGiven I have saved a project with gender and size informationWhen a manufacturer views or accesses the product designThen the selected gender and sizes are seen | 2        | 5                | Functional |
| US16         | Create Project or Project Blueprint                          | As a designer, I want to create a new project that can also serve as a design blueprint, so that I can begin creating. | Feature: New product design or design blueprint Scenario: Start a new product designGiven I am in the web application or the Design LabWhen I create a new product designThen a blank project is initializedAnd I am able to compose my design Scenario: Save to my projectsGiven I have created a new projectWhen I save the projectThen the design is stored in my projectsAnd I am able to access and edit it later | 3        | 5                | Functional |
| US17         | Load a saved product design or design blueprint              | As a designer, I want to load a saved product design or design blueprint so that I can continue working on it without starting from scratch | Feature: Load a saved product design or design blueprint Scenario: View a list of my saved designsGiven I am in the applicationWhen I access my projectsAnd each item preview reflects my last changes Scenario: Load a selected design blueprintGiven I am viewing my projectsWhen I select a projectThen the full design is loaded into the Design LabAnd all elements, styles, and settings appear as they were last saved Scenario: Continue editing a loaded designGiven I have loaded a saved product design or design blueprintWhen I make changes on the canvasThen I edit the design freelyAnd the changes are saved when I save the project again | 3        | 5                | Functional |
| US18         | Delete a saved design blueprint                              | As a designer, I want to delete a design blueprint I no longer need so that I can keep my workspace organized and focused. | Feature: Delete a design blueprint Scenario: Delete a design blueprint I createdGiven I am viewing my own design blueprintWhen I delete itThen the project is permanently removed from my projects | 3        | 3                | Functional |
| US19         | Enforce design deletion with ownership checks                | As a developer, I want to allow designers to delete their own blueprints but restrict deletion for non-creators, so that permission boundaries are respected. | Feature: Enforce design deletion with ownership checks Scenario: Allow deletion of a design by its creatorGiven I receive a deletion request for a design blueprintWhen the authenticated user is the creator of the designThen the design is deletedAnd confirmation is returned Scenario: Handle deletion of non-existent designsGiven a deletion request includes an invalid or non-existent design IDWhen I search for the design in the databaseThen an error is returned | 3        | 3                | Technical  |
| US20         | Duplicate a project or project blueprint                     | As a designer, I want to duplicate an existing product design or design blueprint so that I can make changes to a copy without affecting the original version. | Feature: Duplicate a product design or design blueprint Scenario: Duplicate an existing designGiven I am viewing one of my saved product designs or design blueprintsWhen I choose the option to duplicate itThen a new copy is created with the same content, layers, and metadataAnd the name indicates it is a copy Scenario: Access the duplicated design in my libraryGiven I have duplicated a designWhen I go to my design libraryThen the duplicated version is listed alongside the original Scenario: Edit the duplicated design independentlyGiven I have opened the duplicated versionWhen I make changes to itThen the original design remains unchanged | 3        | 2                | Functional |
| US21         | Publish a product design or design blueprint                 | As a designer, I want to publish a product design so that others can view or use it within the platform. | Feature: Publish a product design or design blueprint Scenario: Publish a finished designGiven I have finalized a product design or design blueprintWhen I choose the option to publish itThen the design becomes publicly visible within the platformAnd it is labeled as published in my projects Scenario: View published design as another userGiven I have published my product design or design blueprintWhen another user browses the public design sectionThen they are able to view the published design with its details Scenario: Unpublish a designGiven I have published a product design or design blueprintWhen I choose to unpublish itThen it is removed from public visibilityAnd still remains accessible in my projects | 3        | 3                | Functional |
| US22         | Share a product design or design blueprint                   | As a designer, I want to share a product design or design blueprint with others so that they can view or duplicate it from their own accounts. | Feature: Share a product design or design blueprint Scenario: Generate a shareable linkGiven I have a product design or design blueprint savedWhen I choose the option to share itThen a public link is generatedAnd I am able to copy and send this link Scenario: View shared design as a visitorGiven someone accesses the shared linkWhen they open it on the platformThen they are able to view the design and its detailsAnd they are not able to edit it unless they duplicate it, taking into account they have a registered account in the platform | 3        | 1                | Functional |
| US23         | Support publishing of product designs and design blueprints  | As a developer, I want to implement a publishing mechanism for design blueprints so that designers can make their work publicly visible within the platform and retrievable by other users. | Feature: Support publishing of product designs and design blueprints Scenario: Publish a valid designGiven I receive a request to publish a product design or design blueprintWhen the design has all required fields completedThen it is marked as publicAnd it is exposed through the public design discovery endpoint Scenario: Retrieve published designsGiven a public user accesses the design gallery or search endpointWhen I query for published designsThen only designs marked as published are returnedAnd private or unpublished drafts are excluded Scenario: Unpublish a designGiven I receive a request to unpublish a product design or design blueprintWhen the requester is the original creatorThen the design visibility is updatedAnd it is removed from all public listings | 3        | 3                | Technical  |
| US24         | Implement design sharing via secure, shareable links         | As a developer, I want to generate and manage secure, shareable links for design blueprints so that users can view or duplicate shared content. | Feature: Implement design sharing via secure, shareable links Scenario: Generate a secure shareable linkGiven I receive a request to share a productWhen the user is the owner of the designThen a tokenized URL is generated | 3        | 1                | Technical  |
| US25         | Publish product design as a product for sale                 | As a designer, I want to publish my product design as a product for sale so that customers can discover and purchase it in the public product catalog. | Feature: Publish product design for sale Scenario: Publish a product design for saleGiven I have completed my product designWhen I select the option to publish it as a product for saleThen my design is listed in the public product catalogAnd customers can view and purchase my published product design Scenario: Unpublish a product design for saleGiven I have a product design published for saleWhen I choose to unpublish my product designThen my design is removed from the public product catalogAnd customers are no longer able to purchase it | 3        | 5                | Functional |
| US26         | Edit profile information                                     | As a customer, I want to view all my profile details in one place so that I can manage them easily. | Feature: Edit profile information Scenario: View profile detailsWhen I am in my profileThen I view all my profile details Scenario: Update profile informationGiven I am viewing my profile detailsWhen I edit and save my profile informationThen I view the updated information reflected in my profile | 3        | 3                | Functional |
| US27         | Implement secure authentication with JWT and password encryption | As a developer, I want to implement an authentication endpoint and issues signed JWTs with expiration handling, so that secure and stateless user sessions can be established. | Feature: Secure authentication with JWT and password encryption Scenario: Validate user credentials securelyGiven I receive a login request with email and passwordThen a secure hashing algorithm is usedAnd only allow login if the credentials match Scenario: Handle invalid credentialsGiven a user provides incorrect email or passwordWhen I attempt to authenticateThen an unauthorized response is returnedAnd no token is issued Scenario: Enforce token expirationGiven I issue a JWT with a defined expiration timeWhen the token is used beyond its validityThen it is rejected as expiredAnd the user is prompted to sign in again | 4        | 2                | Technical  |
| US28         | Validate and store encrypted user data on registration       | As a developer, I want to validate incoming registration data and store user credentials in encrypted form, so that user accounts are securely created and protected against unauthorized access. | Feature: Validate and store encrypted user data on registration Scenario: Validate registration input fieldsGiven I receive a registration requestWhen I process the inputThen required fields are validatedAnd reject the request if any required field is missing or invalid Scenario: Ensure email is uniqueWhen a new user attempts to registerThen reject the registration if the email is already in use | 4        | 3                | Technical  |
| US29         | Restrict API access                                          | As a developer, I want to secure API routes using role-based access control and middleware guards so that unauthorized access is blocked. | Feature: Restrict API access Scenario: Block access to protected routes without authenticationGiven an unauthenticated request is madeWhen I process the requestThen return an unauthorized responseAnd prevent any logic from executing Scenario: Deny access with insufficient permissionsGiven an authenticated user without the required roleWhen I process a requestThen return a forbidden responseAnd log the access denial event | 4        | 5                | Technical  |
| US30         | Stay Log In                                                  | As a customer, I want to stay logged in securely across sessions so that I don’t have to re-authenticate frequently when returning to the platform. | Feature: Stay logged in across sessions Scenario: Return to the platform without logging in againGiven I have previously logged inWhen I revisit the websiteThen if my session is valid, I am still logged in Scenario: Log out manuallyGiven I am currently logged inWhen I choose to log outThen my session is invalidated | 4        | 2                | Functional |
| US31         | Secure Logout Functionality                                  | As a Customer, I want to log out securely from the system so that my session ends completely and cannot be reused by unauthorized parties. | Feature: Logout Endpoint Scenario: Log out and terminate sessionWhen I log outThen my session is terminatedAnd all authentications are removed Scenario: Redirect to login after logoutWhen logout is successfulThen I am redirected to log in | 4        | 2                | Functional |
| US32         | Invalidate Tokens and Clear Session Metadata on Logout       | As a developer, I want to implement a logout mechanism that invalidates refresh tokens and clears session metadata to enhance security. | Feature: Invalidate Refresh Token and Session Metadata Scenario: Invalidate refresh token on logoutWhen logout is triggeredThen the refresh token is deleted Scenario: Delete session metadataWhen logout is triggeredThen session metadata is removed Scenario: Reject token reuseWhen a previously invalidated token is usedThen the request is denied | 4        | 2                | Technical  |
| US33         | Enforce Secure Data Transmission and Encryption              | As a developer, I want to ensure that all sensitive data is encrypted at rest and transmitted securely. | Feature: Enforce Secure Transmission and Encryption Standards Scenario: Transmit dataWhen the user accesses the applicationThen all network traffic is encrypted Scenario: Redirect insecure requestsWhen a user attempts to access via HTTPThen the request is redirected Scenario: Encrypt sensitive fields at restWhen sensitive information is savedThen it is encrypted Scenario: Protect passwordsWhen a user sets or updates their passwordThen the password is hashed before storage | 4        | 2                | Technical  |
| US34         | Password Reset                                               | As a customer, I want to securely reset my password in case I forget it, so that I can regain access to my account. | Feature: Secure Password Reset Scenario: Request password reset with valid emailWhen I submit a password reset request with a registered emailThen I receive an email with a secure reset link | 4        | 2                | Functional |
| US35         | Implement Temporary Token for Password Reset                 | As a Developer, I want to implement a password reset flow using time-limited tokens, so that only valid users can reset their passwords within a secure time frame. | Feature: Temporary Reset Token Validation Scenario: Generate time-limited reset tokenWhen a password reset is requestedThen a token with an expiration time is generated and sent to the user Scenario: Validate tokenWhen a user opens the reset linkThen the token is checked for validity and expiration Scenario: Invalidate token after useWhen the user submits a new passwordThen the token is invalidated and cannot be reused Scenario: Log token usageWhen a token is used to reset a passwordThen the system logs the time and user for auditing | 4        | 2                | Technical  |
| US36         | Add product to shopping cart                                 |                                                              | Feature: Add Garment to Shopping Cart Scenario: Add a garment to the cartWhen I add a product to my cartThen the product and quantity are stored in my cart Scenario: Prevent duplicate entries in cartGiven the same product is already in the cartWhen I add it againThen the quantity is increased instead Scenario: Add multiple productsWhen I add different products to the cartThen all are listed in the session cart with correct quantities | 5        | 3                | Functional |
| US37         | Retrieve and update cart                                     | As a customer, I want to add a product to my shopping cart so that I can review it and purchase it later. | Feature: Fetch and Update Cart via API Scenario: Fetch cart contentsWhen the user loads the cart viewThen a request retrieves the cart data Scenario: Update item quantityWhen the user changes the quantity of a cart itemThen a request updates the item Scenario: Remove item from cartWhen the user removes an itemThen a request is sentAnd the item is deleted from the cart session | 5        | 3                | Technical  |
| US38         | Start checkout                                               | As a customer, I want to proceed to checkout from my cart so that I can complete my purchase. | Feature: Proceed to Checkout Scenario: Begin checkout from cartGiven I'm in the cart and I see a checkout optionWhen I go to checkoutThen the system transitions to the checkout viewAnd preserves the current cart state Scenario: Prevent checkout with empty cartWhen the cart is emptyThen no checkout is availableAnd I see a message prompting me to add items Scenario: Validate cart before checkoutWhen I initiate checkoutThen the system validates that all items are available and in stock | 5        | 5                | Functional |
| US39         | Create Pending Order from Cart                               | As a developer, I want to initialize a pending order so that the order can be tracked and fulfilled after checkout begins. | Feature: Initialize Order from Cart Scenario: Create pending order from cartWhen the user enters the checkout viewThen the cart contents are sentAnd a new order is created with status "pending" Scenario: Include user and timestamp in orderWhen the order is initializedThen the order includes the customer ID and timestamp | 5        | 2                | Technical  |
| US40         | Enter and Confirm Shipping Details                           | As a customer, I want to enter and confirm my shipping address and contact information during checkout so that my order can be delivered to the correct location. | Feature: Confirm Shipping Details Scenario: Submit valid shipping detailsWhen I enter a shipping address and contact infoThen the information is validatedAnd saved to the current order Scenario: Reject incomplete shipping infoWhen I leave required fields blankThen the form displays validation errorsAnd submission is blocked Scenario: Allow editing of shipping detailsGiven I already entered shipping informationWhen I choose to edit itThen I can update the address before final confirmation | 5        | 3                | Functional |
| US41         | Validate and Store Shipping Information in Order             | As a developer, I want to validate and persist the customer's shipping information into the order entity so that it can be used by the logistics system. | Feature: Store Shipping Info in Order Record Scenario: Validate and persist shipping dataWhen the user submits the shipping formThen the data is validated for completeness and formatAnd persisted into the order entity Scenario: Reject invalid address formatWhen the user submits a shipping address with an invalid postal codeThen the system rejects the submission | 5        | 2                | Technical  |
| US42         | Display final order summary to the customer                  | As a customer, I want to view a detailed summary of my order before confirming it, so I know exactly what I’m purchasing and how much I will pay. | Feature: Display Final Order Summary Scenario: Show full order summary before confirmationWhen I reach the final step of checkoutThen I see a summary of the ordered items, quantities, total cost, and shipping details Scenario: Allow review and changes before confirmationWhen I review the summaryThen I can go back and edit my cart or shipping info if needed | 5        | 2                | Functional |
| US43         | Place and Confirm Order                                      | As a customer, I want to confirm my order so that the system can begin processing and preparing it for fulfillment. | Feature: Place Order Scenario: Finalize and submit orderWhen I place the order after reviewing the summaryThen the system registers the order and begins fulfillment Scenario: Prevent submission with missing required dataWhen the shipping or payment information is incompleteThen the system blocks submission and prompts for completion | 5        | 2                | Functional |
| US44         | Display Order Confirmation                                   | As a customer, I want to receive a confirmation screen after placing my order so that I know it was successful and have a reference for tracking. | Feature: Display Order Confirmation Scenario: Show order confirmation viewWhen the order is successfully submittedThen I see a confirmation message with the order status and reference number Scenario: Include estimated delivery and next stepsWhen I view the confirmationThen it shows the estimated delivery dateAnd instructions for tracking the order | 5        | 2                | Functional |
| US45         | Notify of New Purchase                                       | As a manufacturer, I want to be notified immediately when a new order is placed so that I can start the production process without delays. | Feature: Notify manufacturer of new order Scenario: Notify manufacturer after order confirmationWhen a new order is confirmedThen the manufacturer receives a notification with order details Scenario: Include order metadata in the notificationWhen the notification is sentThen it contains order ID, customer info, item list, and expected delivery date | 5        | 3                | Functional |
| US46         | View Customer Order History                                  | As a customer, I want to see a list of all my past and current orders so that I can track my purchase history and delivery status. | Feature: Customer order history Scenario: Retrieve customer order listWhen I access my order historyThen the system displays a list of my past and ongoing orders Scenario: Sort orders by dateWhen I view my order historyThen the orders are shown in descending order by purchase date Scenario: Filter orders by statusWhen I apply a status filter (e.g., delivered, in progress)Then only orders with the selected status are shown | 6        | 5                | Functional |
| US47         | View Detailed Order Status                                   | As a customer, I want to see detailed tracking information about each order so that I know whether it's pending, being processed, shipped, or delivered. | Feature: View order detail status Scenario: View specific order detailsWhen I select an order from the historyThen I see the full order details including item list and current status Scenario: Show order status timelineWhen I visualize my ordersThen I see a progress tracker showing each stage: ordered, processing, shipped, delivered | 6        | 3                | Functional |
| US48         | View Estimated Delivery Time                                 | As a customer, I want to see the estimated delivery date for my order so that I can plan for its arrival. | Feature: Display estimated delivery time Scenario: Show delivery estimate in order summaryWhen I view my order summaryThen the estimated delivery date is clearly shown Scenario: Update estimate if order is delayedWhen the expected delivery date changesThen the new estimate is reflected in the order detail view | 6        | 2                | Functional |
| US49         | Track production progress in dashboard                       | As a customer, I want to see the estimated delivery date for my order so that I can plan for its arrival. | Feature: Track production progress of assigned orders Scenario: View production status of assigned ordersWhen I open the manufacturing dashboardThen I see all orders assigned to me with their current production statuses Scenario: Update production statusWhen I update the progress of an orderThen the new status is saved and visible to relevant parties | 6        | 2                | Functional |
| US50         | Access the administration panel                              | As a manufacturer, I want to access a dedicated dashboard so that I can manage the orders assigned to my company. | Feature: Access manufacturer dashboard Scenario: Display dashboardGiven I am authenticated as a manufacturerWhen I view my dashboardThen I see my assigned orders and summary metrics | 7        | 5                | Functional |
| US51         | Create secured route and render manufacturer-specific data   | As a developer, I want to protect the manufacturer dashboard so that only manufacturers can view it. | Feature: Dashboard access control Scenario: Authorized accessGiven a user has the manufacturer roleWhen they open the dashboardThen I expect them to see the dashboard contents Scenario: Unauthorized accessGiven a user lacks the manufacturer roleWhen they open the dashboardThen they are redirected to another view | 7        | 3                | Technical  |
| US52         | View assigned orders in the manufacturer panel               | As a manufacturer, I want to view all orders assigned to me so that I can plan and prioritize production. | Feature: View assigned orders Scenario: Orders existGiven I have assigned ordersWhen I check my orders listThen I see each order Scenario: No ordersGiven I have no assigned ordersWhen I check my orders listThen I do not see any orders | 7        | 5                | Functional |
| US53         | Update the production status of an order                     | As a manufacturer, I want to update the production status of an order so that the platform reflects the current progress to inform the client. | Feature: Update production status Scenario: Change order production statusWhen I update the status of an orderThen the new status is stored and reflected in the order record Scenario: Prevent invalid changeGiven an order is “Completed”When I try to revert itThen the platform does not let me change it | 7        | 5                | Functional |
| US54         | Upload Production Reports                                    | As a manufacturer, I want to upload a report or notes about production so that the platform admin or customer can see relevant updates. | Feature: Upload manufacturing report Scenario: Submit report or notes for an orderWhen I upload a file or submit production notesThen the report is linked to the corresponding orderAnd it becomes accessible to authorized roles Scenario: View reports or notes historyGiven I’m on an order detailWhen I view reportsThen I see past uploads with author and date | 7        | 2                | Functional |
| US55         | Filter manufacturer orders by status and date                | As a manufacturer, I want to filter my orders by production status or date range so that I can locate orders more easily. | Feature: Filter manufacturer orders Scenario: Apply filter by status and dateWhen I apply filters using status and date rangeThen the displayed order list updates to show only matching entries Scenario: Clear filtersGiven filters are activeWhen I clear themThen the full list reappears | 7        | 5                | Functional |
| US56         | Implement filtered queries                                   | As a developer, I want to implement client-side filters for search efficiency. | Feature: Filtered queries Scenario: Apply filter parametersWhen the user applies search filters in the interfaceThen the results update based on the selected criteriaAnd a request is triggered with matching query parameters Scenario: Clear all filtersWhen the user clears every selected filter in the UIThen the full unfiltered result set is displayedAnd the request has no filter parameters | 7        | 2                | Technical  |
| US57         | Notification of new assigned orders                          | As a manufacturer, I want to be notified when a new order is assigned to me so that I can start production promptly. | Feature: Notify manufacturer on new assignment Scenario: Receive notification for new assigned orderGiven I am logged in as a manufacturerAnd a new order has been assigned to meWhen the order assignment is completedThen I receive a notification about the new assigned order Scenario: View notification detailsGiven I have received a notification for a new assigned orderWhen I open the notificationThen order details are available | 7        | 2                | Functional |
| US58         | Translate the Web Application                                | As a customer, I want to choose my preferred language from the UI so that I can interact with the platform in my native language. | Feature: Translate the web application Scenario: Select preferred languageGiven I am logged into my accountWhen I choose my preferred languageThen the platform updates and displays all content in the selected language Scenario: Switch language at any timeGiven I am using the platform in one languageWhen I select a different languageThen all platform content immediately switches to the newly selected language | 8        | 2                | Functional |
| US59         | Bind language selector to i18n module and trigger language switch | As a developer, I want to bind a language selector dropdown to the i18n module (ngx-translate) and trigger use(languageCode) dynamically. | Feature: Bind language selector to i18n Scenario: Dynamically change language with i18nWhen a language is selected from the interfaceThen the i18n module executes the use(languageCode) function Scenario: Load fallback translationsWhen the user selects a language and a key is missing in that localeThen the module falls back to the default language text | 8        | 5                | Technical  |
| US61         | Choose a payment method during checkout                      | As a customer, I want to select my preferred payment method during checkout so that I can complete my purchase with the option that suits me best. | Feature: Choose payment method during checkout Scenario: View available payment methods at checkoutGiven I am on the checkoutWhen I proceed to paymentThen I view a list of available payment options such as credit card or other supported methods Scenario: Select my preferred payment methodGiven I am presented with multiple payment optionsWhen I choose one methodThen my selection is clearly highlighted or confirmed on the screen | 9        | 5                | Functional |
| US62         | Bind selected payment method to transaction request          | As a developer, I want to display available payment methods to the user and bind their selected option to the transaction payload so correct payment flow is process. | Feature: Bind selected payment method to transaction request Scenario: Display available payment methodsGiven I am rendering the payment form for an orderWhen the user is prompted to select a payment methodThen fetch and display all supported payment options Scenario: Bind user selection to transaction payloadGiven the user selects a payment methodWhen the transaction request is createdThen the selected payment method is included in the payload Scenario: Validate payment method before processingGiven a transaction request is submittedWhen payload is receivedThen I verify that the payment method is supported and valid Scenario: Handle missing or invalid payment selectionGiven the user has not selected a payment methodWhen they attempt to submit the payment formThen request is blockedAnd an error is displayed prompting the user to select a valid payment method | 9        | 3                | Technical  |
| US63         | Securely submit payment to complete my purchase              | As a customer, I want to enter and submit my payment information through a secure process so that I can finalize my order with confidence and without risk of data exposure. | Feature: Securely submit payment to complete my purchase Scenario: Enter payment details through a secure formGiven I am on the paymentWhen I enter my payment informationThen the input fields are secured Scenario: Confirm payment submissionGiven I have completed the payment formWhen I submit my paymentThen a confirmation that my transaction is being processed securely is shown Scenario: Get feedback on failed submissionGiven I submit my payment and something goes wrongWhen the transaction failsThen I receive a clear errorAnd I am informed that no money was charged Scenario: Prevent insecure payment attemptsGiven I am on the payment interfaceWhen the system detects an insecure or expired sessionThen I am blocked from submitting the paymentAnd I am prompted to refresh or reauthenticate securely | 9        | 2                | Functional |
| US64         | Integrate PCI-compliant tokenization for secure payment processing | As a developer, I want to tokenize sensitive payment data and transmit it securely through a PCI-compliant payment gateway so that I can process transactions without directly handling raw card information. | Feature: Integrate PCI-compliant tokenization for secure payment processing Scenario: Tokenize payment data before transmissionGiven the user submits their payment detailsWhen I process the payment via the PCI-compliant gatewayThen the raw card data is tokenizedAnd only the token is transmitted Scenario: Transmit tokenized dataGiven I have a valid token representing the payment informationWhen I send the dataThen the communication occursAnd the token is passed securely Scenario: Reject unencrypted or raw payment dataGiven I receive raw or unencrypted card dataWhen I validate the requestThen I reject the request | 9        | 5                | Technical  |
| US65         | Validate transaction result and confirm order status         | As a developer, I want to verify the final transaction status from the payment provider so that I can either confirm the order or reject it based on payment success. | Feature: Validate transaction result and confirm order status Scenario: Confirm order after successful transactionGiven I receive a successful transaction status from the payment providerWhen I validate the transactionThen the order is confirmed Scenario: Reject order after failed transactionGiven I receive a failed transaction statusWhen I validate the transactionThen the corresponding order is marked as rejected Scenario: Prevent order confirmation without payment validationGiven I have not received a validated successful transactionWhen an order is being processedThen the order is not confirmedAnd any fulfillment is blocked until validation | 9        | 3                | Technical  |
| US66         | Process payment gateway response and persist transaction outcome | As a developer, I want to handle the payment gateway’s response, validate the transaction result so that all transactions are reliably recorded for reference, auditing, and user feedback. | Feature: Process payment gateway Scenario: Parse successful transaction responseGiven the payment gateway returns a successful transaction responseWhen I receive the responseThen status, amount, and reference code are extractedAnd the transaction is marked successful Scenario: Store failed transaction outcomeGiven the payment gateway returns a failed transaction responseWhen I parse the failure detailsThen the transaction is stored as failed Scenario: Record timestamp of outcomeGiven I am storing a transaction resultWhen the outcome is persistedThen the exact timestamp is recorded | 9        | 3                | Technical  |
| US67         | Get notice of failed payment attempt                         | As a customer, I want to be notified immediately if my payment attempt fails so that I understand what went wrong and can try again or choose another payment method. | Feature: Get notice of failed payment attempt Scenario: Receive real-time messageGiven I am submitting a paymentWhen the payment failsThen an immediate explanation is shown | 9        | 3                | Functional |
| US68         | Prevent duplicate transaction submissions                    | As a developer, I want to prevent the same order from being paid twice so that users aren’t overcharged. | Feature: Prevent duplicate transactions Scenario: Detect and block duplicate payment attemptsGiven a payment is already being processed for an orderWhen a second payment request is submitted for the same order IDThen the request is rejected Scenario: Lock order during payment submissionGiven a user initiates a paymentWhen the request is sent to the payment processorThen the order record is lockedAnd other payment attempts are prevented until the transaction is finalized Scenario: Check transaction status before accepting paymentGiven an order has a completed transactionWhen a new payment request is made for the same orderThen existing payment statuses are verifiedAnd new transactions are blocked | 9        | 3                | Technical  |
| US69         | Store transaction metadata for auditing                      | As a platform administrator, I want to access payment metadata for each transaction so that I can audit or resolve disputes. | Feature: Store transaction metadata for auditing Scenario: View complete metadata for a transactionGiven I have access to the admin dashboardWhen I open the details of a specific transactionThen the payment method, status, and timestamps are visibleAnd all values reflect the latest updates accurately Scenario: Search transactions by date or statusGiven I need to investigate past activityWhen I filter transactions by date range or statusThen a list of matching transactions with full metadata is received Scenario: Export transaction logs for auditsGiven I want to analyze platform payment behaviorWhen I export transaction dataThen the file includes all relevant metadata for each transaction | 9        | 2                | Functional |
| US70         | Save payment method, status, and timestamps per transaction  | As a developer, I want to persist each transaction's payment method, status, and timestamps so that I can ensure accurate record-keeping, auditing, and tracking of payment flows across the system. | Feature: Save payment method, status, and timestamps per transaction Scenario: Store payment metadata when a transaction is createdGiven I receive a successful payment from the clientWhen I create the transaction recordThen the payment method is stored Scenario: Store refund or cancellation metadataGiven a transaction is refunded or canceledWhen the status is updated accordinglyThen the event time is loggedAnd the original payment method and transaction metadata are retained for auditing Scenario: Ensure all metadata is accessible for reportingGiven a transaction has been completedWhen I retrieve its data for reporting or auditsThen the payment method and relevant timestamps are displayed | 9        | 5                | Technical  |

## 3.3. Impact Mapping

El Impact Mapping es una técnica estratégica que ayuda a alinear los objetivos del negocio con las decisiones técnicas y funcionales del producto. A través de una visualización jerárquica tipo árbol, esta metodología conecta las metas comerciales con los actores involucrados, sus impactos esperados y las funcionalidades requeridas. En el caso de Q2, el Impact Mapping se utilizó para estructurar de manera clara cómo las funcionalidades específicas de la plataforma contribuyen a alcanzar objetivos SMART del negocio, considerando a sus principales User Personas.

Para el proyecto Q2 – TeeLab se elaboró un *Impact Map* siguiendo las buenas prácticas de diseño centrado en el usuario. En este artefacto se definieron:

1. Business Goals SMART: como “Alcanzar los 600 usuarios suscritos al plan A en el lapso de 8 meses”.

   

2. Actors/Personas clave: previamente definidos mediante entrevistas y empatía, como Elena Soler (Diseñadora), Marta López (Compradora Creativa) y Laura Martínez (Marca emergente).

   

3. Impacts esperados: para cada actor, se describieron cambios de comportamiento deseados que contribuirían al objetivo (ej. aumentar frecuencia de publicación de diseños, mejorar la tasa de conversión).

   

4. Deliverables funcionales: funcionalidades específicas que se implementarían para habilitar dichos impactos (ej. editor visual interactivo, sistema de pedidos personalizados, validación previa del diseño).
...
“Anexo: Impact Mapping” : https://shorturl.at/ayerz
...
La sección General Style Guidelines establece los lineamientos visuales fundamentales que rigen la interfaz de usuario de la plataforma Q2. Su propósito es garantizar una experiencia consistente, coherente y accesible en todos los puntos de interacción.
...
La familia tipográfica oficial del sistema es Sometype Mono, una fuente sans-serif pensada para interfaces limpias y modernas. Se ha definido la siguiente jerarquía:
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf2HMEHgdMV5rWipimwbf7trpBOCSQMS8MZ1C5S5gE2xEpMHrDmJ3n_QiOePsVWBQpQOjZXc_mlKtFnOhreplg95BM_NVqLxzBm6N5HAOJjA0bZxRh9qj_AaG6IUHKYaXakzLiQTA?key=J06Wc8-GfXXlOJgmuX32uwpk)

### 4.1.2. Web Style Guidelines

En esta sección se muestran los criterios de diseño aplicados a los componentes Vue de la plataforma Q2. Nuestro objetivo es garantizar coherencia estética, claridad funcional y accesibilidad, siguiendo la identidad de marca y los principios de diseño centrado en el usuario. Cada elemento describe el componente Vue asociado, sus props clave y el tono comunicacional que proyecta.

1. Componente CtaButton.vue (Botones Principales)

**Uso:** “Start Designing Now”, “Start Creating”
 **Props principales:**
...
- variant: String = "primary" — estilo principal
...
| **Propiedad**      | **Valor**                                            |
| ------------------ | ---------------------------------------------------- |
| **Fondo**          | Azul vibrante (#0061EC)                              |
| **Tipografía**     | Istok Web Bold, font-size: 14px; text-align: center; |
...
- Casual con intención — directo y accesible.

  

- Respetuoso y entusiasta — invita a la acción sin presionar.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcwvpDYKpYh2svz4ry3Yl_1X7ydNOufz_gYB523HOesWQCz6fbw05DPk4QpnFB3Fx2tk-XqkIBoumgwbfFfJw_k2t0TGTeeXPRhYuvbfHRgUWe-qryUr2V6fCPDKrg3rmWoPWfc-w?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcRotPgpH5npInaeLUdfScmTuniHQo1QK6XqGtbiWjF3bghD6dGsdEmQGH1oO5UsDrpnRv8l-dUojf61DOLUSbFm2Iv8H_r-IxnLVinNJ60G3skoAAxSA11UbwtT5BFz0uIQNPA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
El diseño del sistema de organización en *Q2* ha sido cuidadosamente estructurado para responder a los principios de usabilidad, claridad jerárquica y eficiencia en la navegación. La implementación de una organización jerárquica en la landing page permite que los usuarios accedan de manera inmediata a los contenidos más relevantes, como la propuesta de valor, preguntas frecuentes y acceso al registro o inicio de sesión. Esta jerarquía no solo prioriza las acciones clave del usuario, sino que también proporciona una estructura visual coherente y predecible.
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeNmrUaGUvPrJ_UEJDOMK2H1NVNjrsguDWVD1ljZH4i0d3AHFGDh4rGE8gDTMt5Njs0ZrG7sbXv4UIgKgJbTGL9R0-17OXgf75ninM4puyHqqpke8rs2qRDFp4yJPfvg93dyfD8ow?key=J06Wc8-GfXXlOJgmuX32uwpk)

1. Pricing

La sección de precios incluye etiquetas meta que destacan la propuesta de valor y el modelo económico de Q2. Al presentar información sobre la accesibilidad del diseño y el esquema de pago flexible, se comunica claramente la conveniencia y transparencia para los usuarios. Las etiquetas SEO utilizadas posicionan esta página como una guía clara sobre los costos y beneficios de la plataforma, y al compartirla en redes, se muestra un contenido visual y textual alineado con la oferta económica. Esto no solo aclara las dudas de los potenciales usuarios, sino que también apoya la conversión al destacar la asequibilidad y el valor del servicio.
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf8BN79Bu--mTXWyVa-vlRfD4Uis9BWnH3mtda-Gqq28WX8j4WjTXxc3OxupC9zh5cdPVjzFRZMLd03GylV3Zuqy0E_9czQ51CYP1jh4YQIJoriek2ZIOSJkcVqx-bTdFelgkfbDA?key=J06Wc8-GfXXlOJgmuX32uwpk)

La implementación de SEO Tags y Meta Tags en la sección de precios de Q2 responde a una estrategia integral de transparencia, claridad y accesibilidad económica. Esta página clave del sitio ha sido optimizada para transmitir información precisa y persuasiva tanto a buscadores como a redes sociales, asegurando una comprensión eficiente de la estructura de costos y alineada con la filosofía de valor del proyecto. Estas etiquetas no solo fortalecen la estructura semántica del sitio, sino que también preparan la plataforma para atraer a usuarios conscientes del presupuesto y enfocados en la rentabilidad.

### 4.2.4. Searching Systems

La pantalla Explore es el núcleo de la experiencia de descubrimiento dentro de Q2 – TeeLab. Desde esta vista, los usuarios pueden navegar, visualizar y seleccionar camisetas diseñadas por la comunidad, ordenadas por popularidad y novedades. En esta interfaz, el sistema de búsqueda se presenta como una herramienta esencial para facilitar el acceso eficiente a contenidos relevantes, alineándose con buenas prácticas de diseño de sistemas de información y experiencia de usuario (UX).
...
El sistema de búsqueda dentro del módulo Explore ha sido diseñado con base en principios sólidos de usabilidad y experiencia de usuario, garantizando una navegación eficiente, clara y visualmente atractiva. Su despliegue completo, incluyendo conexión con servicios y filtrado dinámico, está planificado para fases posteriores del proyecto, reforzando su rol central dentro del flujo de descubrimiento de camisetas personalizadas en Q2 – TeeLab.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf875XIBQWVy3YUTMEkuIkEFYWH2k53dpySNCPMNbPBLPLh4jfas9gi3kbc5-QxpBDWjmVyxQN7vaGbVGewnna1LsBNHsfuzAkD_ut61FdlonizK0MyuvMBRO0EKFWgLJeKZjmX?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeDPMvTYcQ-ehOnrDGI7zKf3oVlEvBYtpnCbYMtv0R6T4mUz_5SBsItf95v2rloSrS0z9iku29_xCZJb2sMWXR8Y7Gads0obMfSp171bMdkssScbTGwFQ8xvpfxcz0wcoI_hpHniw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfDHjEGxE_515A284USmyGuZICJWlZHjh1TnnYTSSrMnqeVl87Rqbqvu6vcMvoZzL1Zr3pWvTotCdnkA1KWFuSthNikkDmNZqn3NU43VzKcRj9IL_BAw5B1lxfieOrpvpAo5nkTFQ?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe6SBnV17XPtzw4u2m5OXoH_Tcchu4qeKE7CrDQgpTVBodrZhI-i-BSmZjZT07GAsHkF2So810uObcxYbqzYqmuGHU5g_29cOwhpl5IJRBAOXO370LOoQQQWElnNQCykgTq9S_EqA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdRsuBukZ2N93tU4rLrxlFZuPWsoPHu02O7m-hvinQa_q98xFGgukfxU-GPdzWsMNPnrGANXbLTnb2cOy6omdGo13FRgniyOyqPnWZd_Jgf7Uzsz_U1oVujOOUHbdT13axR_orvcA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfLS9hhHYZySXWyk0JxG11UZXseAJoaUMuLugZO_onuEDX-fyExd2OKRenloBVVSSgJzkru34pn33p3IVqae8fLnKaPl1TIc45-jk_c9Pf80eaEIKrBqiENwaTdMiZt2pGb3fSh?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
La sección de precios presenta un diseño claro y directo, destacando la accesibilidad y un modelo de pago centrado en el valor. Se divide en dos bloques visuales: uno que enfatiza la facilidad de inicio y otro que explica el modelo de pago. El uso de imágenes de camisetas impresas ilustra de forma tangible la aplicación del servicio. El texto conciso y bien estructurado comunica los beneficios clave de manera eficiente, reforzando la idea de que comenzar no tiene costos ocultos y que solo se paga cuando el valor se materializa.
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcEt52fl4zzwgbDPh8bmFY3BJRPKvEtOJnw0nIgWlJaUKvVlHQBrW-CMR8w2B7lWcCOBAnJpbVwkhPgsRqBcgw26V3ZyHwCAAyBrUb0V7DvcS_qEg7p1mSR-kRWf6jAR49VdTEbLg?key=J06Wc8-GfXXlOJgmuX32uwpk)

En la versión móvil, la sección de precios se organiza verticalmente para facilitar la lectura.

- **Accesible por Diseño:** Se destaca la filosofía de que comenzar es sencillo y sin costos ocultos. El texto conciso explica que no se requiere suscripción ni pago inicial para explorar ideas.
- **Solo Paga Cuando Importa:** Se explica el modelo de pago basado en el valor, donde solo se incurre en costos al obtener resultados tangibles, como la venta de un producto.

El diseño prioriza la claridad y la entrega directa del mensaje en un formato optimizado para pantallas más pequeñas.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfkekkPkIR0hGFBj-M8gyiHqoaYbNBDrsRX0Ecp_UcpGqJRwhUIreoLc6gFwKasYAFzZGAUNpOebufO2OQ1iy3tOVHfwogr9bPsidmWjC8lMZ6fBLqV_PRVmYEzLtgSo2tzuIIP?key=J06Wc8-GfXXlOJgmuX32uwpk)



Los wireframes desarrollados para la plataforma Q2 permite visualizar anticipadamente la lógica de organización, navegación y disposición de los contenidos en diferentes dispositivos. La versión desktop aprovecha el espacio horizontal para distribuir la información de forma jerárquica y modular, mientras que la versión mobile reestructura estos bloques en un flujo vertical optimizado para pantallas reducidas. Esta dualidad garantiza una experiencia responsiva y accesible, alineada con buenas prácticas de diseño UX/UI. Los wireframes sientan así la base para el desarrollo visual y funcional del producto final, facilitando decisiones informadas durante las siguientes etapas de prototipado y validación.

### 4.3.2. Landing Page Mock-up

Los mockups son representaciones visuales de alta fidelidad del diseño de una interfaz, que muestran con detalle el estilo gráfico, la disposición definitiva de los elementos y el lenguaje visual de la marca. En Q2, se desarrollaron mockups completos para las vistas principales del sitio en sus versiones desktop y mobile, manteniendo coherencia visual, accesibilidad y diseño responsivo. Las vistas consideradas son: Home, About, FAQ y Team, ya que representan las secciones clave para comunicar la identidad, propósito y funcionalidad de la plataforma.

Home Page

- Desktop Version

El mockup desktop de la página principal destaca por una estética minimalista y moderna. La parte superior incluye un header con logo y enlaces a About, FAQ, Team, Join y Login. El footer contiene enlaces organizados (Home Page, Community, Legal, Company) con íconos sociales y mensaje de marca.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfK9b1og4-fXzxLItCYEaKQWP3Q-YIm1ms-uzq1ZJLrgHRmifKS2YvCTzXQHxzXFRM6GJEW2Pn7KVJY1BpiyMcpwPj11YcD2Miv1Xj-6PVYyzGC934ozvhpSGSsISSUsgf2CKKLUA?key=J06Wc8-GfXXlOJgmuX32uwpk)

- Mobile Version

La versión mobile adapta los elementos a una estructura scroll vertical fluido. El header se transforma en un menú hamburguesa accesible y los botones Join y Login se posicionan de forma visible. Se mantiene una buena proporción entre tipografía, márgenes y altura de botones, asegurando usabilidad táctil.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeYtbCgPbQ6ZX38fiMX2QwhEZcB23HWXGaFfeZys9B2WEzvP2FWXbdIKQ1-r3Lrl9J4hbfTUhcOWeAz_iu_24NoqMG6QNxEt_fOd7A-3py4IKG-7NLG-kpfwfaaoEvLhSb-TGWeNg?key=J06Wc8-GfXXlOJgmuX32uwpk)
FAQ Page
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdHYiVcowBAfOgc5SlZ4BHZesgbVNKc8tVIKw8yNSvzdBhtdHej0ViyMboeTAqB7DNKMKD6PAXraw-aiJpnkNhG6HS8iH84V65LAwHzw9ASbq4aPOXwhqSc_zGk40jhlj3BLr-MHQ?key=J06Wc8-GfXXlOJgmuX32uwpk)
\- Mobile Version
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdE8ZMSbbmJQfxdmt06oBHvjEK3qAVQNVASPF7lImpG_RMPVvxlCcRtzmXab038oD7bleC7j9NEpPjGIYpjwAvdOCGPyP20QYXyjb28H9q3EO7F8WX9MKgcFwo2XNA_1HlKj-PcBA?key=J06Wc8-GfXXlOJgmuX32uwpk)
About Page

- Desktop Version

Esta pantalla está estructurada con una introducción sobre la misión de Q2, seguida por “Our Story”, “What We Offer” y “Why It Matters”. Los textos están acompañados de imágenes representativas y llamadas a la acción como “Learn More” o “Learn Pricing”. Predomina el uso de fondos claros, espaciado amplio y jerarquía tipográfica bien definida.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeSvMP3AfzSMo348ZecreqBG_szIBfcYElBDzdVun1wqMv63H5-XDPqolKQokI8tUNXLjvciRlYJF9oRyurWYSPJplF7sHpU3pz_JXlR7qXF7XFa9NJ-vLAnrfymKZ4bhhPV4sl?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcwAmgNDzcPYZDnDTy58ZabTWqbr6OQi3_pANqf5xvLOSsNTgSttRjpOeWp0-UlHhPSYSx5hcCdX056GqnpCLSgU0EQkh4qstQfJJGmDBnByAwYmNauH2kJwIYtwHr-KZhMjVIDhA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf0KgjIiMJ3t3WrsYVjXPa4sY65YBfVvvtHxTmDZfui1jcClzUErxi1o01r2XqzIkE4gEVj4sN2jPRDrEjiFpXVdAogVfkE7CHud769e9q1CweR1uck3ZoW_hOmKqVpBuLMpxLi?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcR3_d_5swtkRsjDKXP19ZtjtHb_m0guKkGZAGav50nD26fjCotBHObpR26vHoQQSl00fQDk-Yz7AaLtoEIuksbHcSIL0xM-RVkf5ffp1r8mVY_H2GXrovPrvYtcuDhK3OL4HlXGw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe4nHWBKPM1brcUrbZvsYXIWfg6zK9r8pORPwouvl0Rc-lUBviZ7vNv5NRokHGyS-o2Yhvaj7jJhwGAsTzwh-GRnfHA-YgfG35RirXYj_2YJeujEXMZ1eXlf8f1hWK1yZ9_C6ZKNw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfEOU1WN0WrBdOYr4qMcoAidYT6E6KMGrn9ltVjpueMchtaXgwSFADIa3KtsrxuB-Ey_MrYfQeqpfcZHqxc_BOiHCNsJCd4AfPoc7XESgtnq0XAh8el35VS-vc1xNv8hhssGPl7xA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXexIheKsLVBlWpJYCIexO_VDsRLBAEqecZBpxlDrvJcMgLHZIr44a7ioMJGvTonbCJUV08UIex9ZhpPDxXNic3SZvUa-bDBjo4LFI9j-u4Ofn2EavF5xS_4H4FPdXA3lQ?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXefi-ZDJ6BGXSOJ1a1pxaJixvidEFwew_QoG_mlR2k5fQwsQg0kNwxmOL-fHMmRtttTyHHf8yWRqU-_5FiiPJU8N55wEuUIP53ogZb3-7tWIdRfEaFg0Zi6YHIGey4b3y9PfMrniQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcedPZJUsquDAIFmIYaLJyPGMqTsfq9p6kcbhc_w4kA7J8gehglZZmGZBHpP7aBfSext8oa-xtAZOvlCepqRk846EnLXjM6At6KZyP77ZutrrHemsMDHhmxhHmTgoVRKS9DoMP0Eg?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcgyOhZAt2WXzB7xqbOrOQVIaWAL5GXvOle7zZ0ubyyZDDXelC5JOfYcRuo_LNACoTKCsKfEE1szwa28bl_yhKVrppjOrTjKwB45ALYb2xxHB3nqu1mrIrg5uJkDJIkUKOQacMi?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe9035jv9mGlfS4IGBQg7o-YGCqymNhp7VdpESuaQ-RYZ-_lhSjApnb-4-9nugTvettjfcPbr8avYCI9FNAqbMJ8Yrp6RtrYjTNvfmVLMP_V0XRilItCafNi6PJ7-15VbBl97NhhQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdRuXTOZrHeNxTPi7C_3pkOqRxHJz0tbuHxL90gZDYilwOJJKdefg8QNKFczQGanM1pj0UX_lcWFlPwa8QMcOLznH01nYJ_l2FNFnmHXpomYxjIgJbaGnx5Sh5bV6ElTqYkKw1Icw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcXlKUNoxqEP8yF2xCb-HZZ_ub3DiYroRCqof7F0ZzUrjrXuRKGonlWBLJR9ZxuPuT89g3Nkiv4xUDB1Uim2Ec5Upj7r2o7T3jGR7mUGKkkX26qD__OcXxGsM0UcnVv5H1VCYXY?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXetgLqIcioxKSKmfvC2TP0mziw-D6XY4rA2-a7rCZqcoJ8IhPuOg6fcY4tpTXJRfOpgcmdPY60lvpokuqO38p_Ub7e5Mce-hAyw2KX6CmU78uUag8CxJ5EMZ6MTi43cTlnmKIQ0Iw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd6epfjd-OtyNosr9DzsHfjjuX5CaIim3NMeNkBSE3AWeQVzT4EGm2Gp7AtYlrhqHrWnEBXEfXqHBfoIxBkNHjePfdPd51fg1h4Frdosv-rdejyU_X0sUA06sem_Rj7JfXBHNWFcg?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd9cN4Ecaj_MzbEG4qnPAMdprbym9LQjJAe_yhUbNnjlC_bE--M2Yz4ptvYHnCPujs14uyH3EJjIpJql2HEgurVBZ6mmFmrARtMdXn0jRoMhUFyii2HRz-WW8MrMTC-BiEzvQIrog?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdwwvBckXUCYOd_XNbBVSmeg26EXK3vLfq_ev0USFQ2pm6L6w1MlPNDcF6b7DBdGwNCAACuK5tOyc1cSbhWUZ7WngsKPxZV_Kh5b6emzaIlGP7a8hbD-RSY0xL19PMGmDkfUVZh?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcswy63tw8Ie1jhcB2VItyF5BK_zBcUAjc3g0s4ts1aiNHiTfW5PVnmOI_MXiVfjEb5N3Zmc5I2Lk0VLptGf8ag6nzp65TMh3l_oG_E7_3rYZbfeMyxFRbA0ddPk0xETRIQ1xP4?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfb4pDRw3OOUNSCwnLxdh9iq6OZeC9y1RAfmG8_VHe8Oy73Ro78R2Np67xPf0O3vjq9ylFvsB6QIL54jGxtOhdFPGGYHS-j3ENC4t1UHT8fg0G8PNQoijyW6tUUvqGmzd9G2g0P?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcEtQMMMIRe4iLMJUdO_e574Z_mPdHEaDnTXz1UavhnPZXfle_5jnjxMMWI5QRFglS7xcXAuO1opHFCsd7dBdkxn63M7T2-w9gmTxIafBzuqnG_zexfurExoGf5bYfNRp2BwAAkwA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd-6E4eBelUorZ9i5xIWQTZYKaniQtXqpKa93sxmaJzTqKk0_VfOvVhQsmIjx9qVyW_v_2Us9ZtqdVhQQ1CyMkLouHl7aKo4tn-gg-yLq2yEQhWrl_K_o6-Pu0jwwdjOxNv-uLpYQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXecA4gaWIEW6Q3sGOF0OQfL2bR875clf3p7GB4uTBCdgDngjz7jWZe34jCQ082rs2jBSoPMyEhf16Kbx9Zthj8w_Vsr1kyLP24HgAJl3Mx2QeSj0osOpgB8qo4LJEGnL237St611A?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
- Esta pantalla muestra información como el nombre del diseño ("Bocanada"), el creador ("Q2"), el precio, una descripción, imágenes del diseño y posiblemente una sección de diseños similares.
- **Acción esperada:** Obtención de información detallada sobre el diseño seleccionado.
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfacOmszQT_MkRUwvNm5w4p74ea8L7TQNYVyu_fERPjL1X3rTGKJDL-Q_V5pvJt88lNGU_3bK-GayYwMusYE5dos5ZNguFpf5fxlQKSLr5cNmRwbqVi8hkmLNydnTGYo-CcL49B?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcKm5ZXhGc62WeqqRyCAuC8Pu9N8kQoZocpRblQLZ0dIHMntZQtHSK7mpcmHr58k-cEDhd5XEYzQEjs5-PbWxLPp0PX4g7QaIPAKWJWs7yQ-3sP0nzZ0qqE3hq9z9k2sEmozSXb?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXekzWfmh8t1aKv0ra7TXss9ML24VFwwpjPiQBCif441VjuQ5HtzvAF8lgYPD_3awIwh7KxPHnITjeF5LjWtliYUyjaO_WrHBtObv34E3RmHGgC6yDgj7m3TDiFlCd7F7umNJGAg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfepe4Cvy6AFQBi-I_B01XRmXGRBktRGj2l5sjFHBk_Z6K9KoLi7SP-UOSHpw3uAVMkgROT8mQvK_i_5Ck05YOQhZmVCC5m_PBQ2Tysd0CKjN0bDmQL4X_sKZ7QwJ5g7jeyM14k?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeYFLXMXnNEs1R_isltzm1xCjiZGu9urYjIxvBJqWpDCRUT85P4x5kMPGQrBrCNeAC2o-oG3MvqRKkw6-ueMg-e-38NSI8BoRp3yZ-p-hRw8DnEFa8TfWeE-mtzhlHDXy5ZzKH3?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfH1WEFztdjjxbuqt0lmIWA4al9nUzSHli4nYPXK5PH0Ikz0JhjU7KSAsuxGHXy1PSAyLwUEqOUuATehTWOTw9hzK2_oQJyC6JRrG-QD42IeFnR9lubjh9OXwzRPiqIZrrvO6Fetg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdN4wN8BSSjYAye9yFg1DtVeAPsD26xsYGwgjLzexQxBwN2rNnvder6Mw18F_serdUcmV8R_O0QAun35aPOSQR7tuTHSfNaRHYF-FoiO9RQUSFBLZnB82LvTWM26M6eqNErpios?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcRvrbmlKiRfBZNxbLsiPy_7aAfHDJh5zEvxa8xPQBPOmwIELjunKRSaTUR1z3IgJT52DhyWpj24T61FXANOQBwVSw2yISo88ll6EsH_YfiZ_GuIt8lGMyWW5zktatq8lkgKnKkKQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdqbun6zc3WlaFilUGPRYHpJWuTICaCASxhfVnRpPDZ5ZDCW_hyLUBuh1lsWudkkKF8HMSP-6zWoDeC88xk5M3JWvN7cTU9shiLOax2HSiG0OMwlVYltU0YXBk6pdJ5EQUVibmTcQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdtHe6dH0pjahR5TjfrKUMTvRbhlkR5mjpV5lZPOYF6-OZSxPo5KnPtfmWoPCdWygqImCzXm3sn58yth-R_N0RA8KUnKy7YFpHmHBf4y6jZyj465MMpmOVhm5WkAcof5ur_BG0nsw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdp1hWlZbpj0MEI0G3N596mF9YV-hspdmUUT1NUUCiseOLv8qiW3VPpegjlhr8LEzHXdO6Lciy90BLOjf3TqcP66O8lDghj1QonbkV-oTv9n6UJ2-sbVuABkCijStyY3imjlhSSiw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfQW_eutalinQUZOB9znimtXUyTuB4Z5pSiq2puykeOQjmTfUN11AJEX8qBBouKt0oBd_Rs5-FjfOU3_WJJ-_5rZtd-zF765riEZxUbuUdGIK_KFhQEbQ0r4xRkC0PkWKZw_sE4og?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfgB4Z-E66r0nXOHDX8chAV25XB5NMfO0TmrUBylBrpI5ueXsU6O0t9sV2oR0xMRiONNadlJDf4Lsw5IJjpVkukMcHiOd7NJpW62LExTEp43gboZ3C07dEufN3MzHF6sLjQwytgaA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfXqdAMDZKqQarwgd34hsyiN4YshDLGxGQl6Xm4bAblsLOE0GgrZiITVkTXXPTNR9lVz-oB0kf67NFEFKqc-rciGT0-WOR7tyFXavUQs9j7P0j4gij_oBFPSJgBqC0B5Xc0Opj2?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeWaHj05-y3shXoq5NyfZSTpaZrFy_BtpLW2MpVP6X-HVTpx6AeBvvAIkPf9WfPp-V3wEkhuB8vD42SkXoHGf2rd7ryXx7jPfBoDFKxCTDGohEtnWO7Cpvrmv44DdFvQADHk222Yw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXerQ_rEEnwxOGMEy20kWbGlE53sAD4IffRD3iLIE2Rk_URIjAsUTcaufpUNwVD18KIPXyzUjbXbrOnOy-KqmWVy4Ebfqg7oFh034Ma8LsBCsP1GIHDDVYzeqPYSfJEr12qz5nG1?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcy-mJHPee7ATlL2tu9ruMF_yNZtqzZBWuYdSm5liknvs283pBombJgO-dAJbe3qtNgKXXhyt4ItMSnwbBjkN0Pg0j3jHmFkKd4amM_EJYoA-4Jpjlx6F1GMNVBCSikOOIXdXr5TQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcBDUVAwSOTwxVULLYjYWlMAHEY2taUIvPXUTrntHZyQC_aTxUje4gH8jiHPhuDNhBdxv54nQ8G_yqR9hnPZ3EizWy_ocYTdd3AQKbjEctA9eC1LJqmSYh4OIxcy5yXlRXxNlSGcw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeVRSqeSmIWPy1UAU5CEHrPMbCLHeaUN_X3uKin_eTtxtNgSrFZhVcAJFqE5XXE84W5xutwc5om0DqrN1HZBOK1ZSPQoGvkpZcHdG93ikKRdcfNjevoCIaytdNMZKWLqD5KwyXO1g?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfl-fsy4qI486imXD37m7u97LYgyEAYuDeEa8JNYxZF5rz5jMAxl8IVRSvyYDUf0KxwhvRp4rHavW_sZMRmA10ED3z5RmZxNsTeuZRNPoCTFN-MVlM7REXtyD8TWU5Gkn6jV8CW2w?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXevZ1lYjsgCLhsJ5-VBO1YANYG8F98QbZzLe82cz6GznhsbVogiJ3vUmQbiUJoslQd_6s6jZJdRe785vtE1N8xxcps2nJ9uA7n2B0bhCB5HT2wveYlKgSfYxZSOhHBOCLh4MT-icg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfAoMRlF9p50gmQsh_K5yNovoBs77B4HKV81pmchNs91s6ygdM4u-fVQmBuilpWouq3gDRdAZRb2a6GlfoajSFlaw-w8MwxApMmTpuig5Lxgr-23DfZbFXtGjszKTUqcZn00kqxTw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXffPn9W-Tf85pnvF84BgSJGOZrcZTEwYGG-M0OihRaKYhKycTzGrF8IpltF8HsaevqVdpwjFfvoB1VgGxBAfzNk0JVGzMER8BnjD7eCsTwqL3BOUnzgpmzdrnqbIm9zRsjf8mo4iw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeeQ75bbJljVQKlkbdFGrYXkE4dFj0qaSnIHWYa-P5zKdieC1ugEm6PbwzlIlxf_NgJ4SIFBzfdTfleYXGWM-bya_rkYYU-BUzns_rgz1ma_HyC4HrlYzxj5JmiAKFTacfg3-gjOg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdVA_rvIFM9YKJRbFpKLAJTwmk1Cq1xYGrS0HOKRfEYZ2JvfYX75I3GpZJu2w9VDvy_fWttfXPkUD6lAD3mYwKc34R1TXMaDzOyLzTtFUWXVUqMS52medA5y08a66L0EgDERzV1Uw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeGWHWeicTptdFFR4Oh4lC4d5JP3Cf99R3UIPrLeu34R1m46y-IlHxv5VP7NhYJpKT-Lkci1eWYAwcgAqvs2KRPkdELoDi-mzRKQ3DCdJOqJrwF7Of0qGSndHlTk4kKma_ryP3R2w?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
upc-pre-202510-1asi0730-4395-prototype-q2-navigation-sprint-1 https://shre.ink/x5dH
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXffjbqCbRg_ooyVX4rBTk007DOw0cia47BAARaM2bgT6lDSQv18TyS_vkg4qCXeZETLXVhJ5SYfxlkiFQPC6P-n5FvDu6FIdn8HR4Du_oru9Cze7oJFC8X941AcionL-uVg_L3FjQ?key=wLsuErVgqDz-qczrBI4kMctR)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeKzxvK7TeHq1oW_hbtD7xAVP-zNxdAtmHF9bl9zfz2zTn3Ta0Fdj25W1e73AmVRfAzKTxsHbHtNtJaZBG6USNukPS1jlWFESPgtruPz4FeQ0Xzo0myutG31VnEJ862deojA74uzg?key=wLsuErVgqDz-qczrBI4kMctR)
...
Repositorio con los diagramas de clase: https://github.com/q2-open-source/docs 
...
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------- | ----------------------------------- | ------------------------------------------------------------ |
| JetBrains WebStorm![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXftajnSyMDw9P_1BL5lju8wwGDScqAbCxONSpJI-59_BE-qyAaS8Kb25TnWhdNPabJeoeoAR8IYJBNONZLVfcldpQXv7LOf0EV4Dohoi_Juo4_nIOcgGy9J5m8DWyWK7kMJwpQp?key=J06Wc8-GfXXlOJgmuX32uwpk) | Desarrollo web moderno (e.g., con, TypeScript).              | Software Development | https://www.jetbrains.com/webstorm/ | IDE especializado en desarrollo web moderno, con soporte completo para TypeScript y otras tecnologías frontend. |
| Vue CLI![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd2Q0eBhgokbGuPiejqDh2tnFf4SI3VArPoBtGayHndZ-csEwAJDjRp-XNccY0tXJbg4omP1NdPmnIIilhZUJSp7xZ49kZUUvpJxjow7l3dHkjAasTtQBPAC6dk84sFLfVnSvcNCw?key=J06Wc8-GfXXlOJgmuX32uwpk) | Gestión del ciclo de vida de aplicaciones Vue.               | Software Development | https://cli.vuejs.org               | Interfaz de línea de comandos que permite generar proyectos, componentes y servicios, así como manejar el ciclo de vida completo de una aplicación Vue. |
| Postman![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd-gLSz_MUYIyFqzVHRKYv4aCC8TCVDOtQATR3VEld7D_Ba92KP3ITpbp9LE9YYB-DCyw-31qts8LiuUGjLAoXzQiMuARcerjXTV68UbwHy9RlFrOx7lwurDLvQKQpGbL9pymQjfQ?key=J06Wc8-GfXXlOJgmuX32uwpk) | Prueba y documentación interactiva de APIs.                  | Software Development | https://www.postman.com/            | Plataforma para probar y documentar APIs de forma interactiva, ideal para validar endpoints desarrollados con Spring Boot. |
| UXPressia![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcswigcyHXYmM85uYCPNqzYtvmRVVxxDOpA8xJcacfhg7YHn_-iukZS9jRNAi4VJWft86viQfwCR0j_BDk-_U76MDRYREpkfTkQBhdnlnGLpxUoqmEdOQd_KWMC31kylAQA8eyE?key=J06Wc8-GfXXlOJgmuX32uwpk) | Visualización de la experiencia del usuario.                 | Product UX/UI Design | https://uxpressia.com/              | Herramienta enfocada en la creación de journey maps y perfiles de usuario, útil para visualizar la experiencia del usuario en el sistema. |
| Lucidchart![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf4CZ1EnkgYGiNZkRibPJofZBREbIlIPBXSWXMwH8XYMSRomL8bc9S4S9YjVUUexYXYPPdyyWf7TDxlQvY6kPorXG-OvF34b47CuPFXNwPdwpqnzky8_P2bMQ4-S3TDngPCM7M9Bw?key=J06Wc8-GfXXlOJgmuX32uwpk) | Planificación visual de software mediante diagramas.         | Product UX/UI Design | https://www.lucidchart.com/         | Plataforma para crear diagramas de procesos, flujos y arquitecturas de sistema, facilitando la planificación visual del software. |
| Structurizr![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdSOs-fyWLsBMrKzMLInqkRSnVyN-OSRdn2RfuPp4fdjMSp9qCyhVRiu0LaefO9YLzJPIO2Oxbw3wWxdwH-sGqV4Ygkfsdj8IVE5B-5-azQ92_6kDLxBZ5seXLTDhnIvjQ0BXvtAQ?key=J06Wc8-GfXXlOJgmuX32uwpk) | Modelado y documentación de arquitectura de software (Modelo C4). | Product UX/UI Design | https://structurizr.com/            | Herramienta para crear modelos de arquitectura de software basada en el modelo C4, útil para documentar sistemas complejos. |
| Supabase![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfjcmtCkmdiwzsiNi3F1pTxCUff1z5zILqOJYExR6kRlG6cy7Yqe1IQ2eBVjk1XRRkcaEdzhokC6pel4XE2JVPwJ3H__3aiZH3SiI0mlhXc7rW5m_izuJw08UE9Xvl-YYcABfMG?key=J06Wc8-GfXXlOJgmuX32uwpk) | Almacenamiento y administración de información para backend. | Software Development | https://supabase.com/               | Sistema gestor de bases de datos ampliamente usado para almacenar y administrar la información estructurada de aplicaciones backend. |
| Firebase![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf0-bnivtz9h1w6paTHL8Q67FZRsizUyjP8V6H5x6Pf34TfT1jjCVlAraoYgPL1EGOL7_9lYqqyyqDOhXbsnBXi5ZLwmj4NllOz9I3GVcUHvtfRXD-44l2laRTCVRrxcKgTQrQH?key=J06Wc8-GfXXlOJgmuX32uwpk) | Plataforma para desarrollo de aplicaciones web y móviles.    | Software Development | https://firebase.google.com/        | Plataforma de Google que ofrece diversos servicios (autenticación, base de datos NoSQL, hosting, funciones serverless) para acelerar el desarrollo de aplicaciones. |
...
Los repositorios oficiales se encuentran alojados en la organización ([q2-aplicaciones-web/landing-page](https://github.com/q2-aplicaciones-web/landing-page)) de GitHub, estructurados según los bounded contexts definidos. Cada contexto cuenta con su propio repositorio o submódulo, lo cual asegura modularidad, independencia de despliegue y autonomía evolutiva. Se utiliza el flujo de trabajo GitFlow, control de versiones con Git y commits semánticos según la convención Conventional Commits. La documentación de arquitectura se genera utilizando Structurizr DSL, lo que permite construir vistas C4 de manera programática, reproducible y compatible con el modelo del dominio.
...
A nivel visual, se sigue una codificación semántica en HTML, usando etiquetas como <header>, <section>, <article>, y evitando el abuso de <div>. En CSS, se aplica la metodología **BEM** (Block Element Modifier), que mejora la claridad del código (.register-container, .intro-section__button-wrapper). Se utiliza **SCSS** como preprocesador, permitiendo modularización de estilos, variables reutilizables, mixins, anidamiento y separación por temas visuales. Además, se prioriza la accesibilidad (aria-label) y la experiencia en dispositivos móviles con diseño responsivo.
...
Hemos optado por Netlify como plataforma de despliegue para nuestra landing page debido a su robustez y flexibilidad en entornos de desarrollo modernos. Netlify ofrece un flujo de trabajo completamente basado en Git, lo que nos permite desplegar automáticamente cada vez que fusionamos cambios en la rama principal, garantizando que la versión en producción esté siempre sincronizada con nuestro repositorio. Su interfaz web y CLI intuitivos reducen al mínimo la configuración inicial, permitiéndonos concentrarnos en el código en lugar de en la infraestructura. Además, Netlify incluye funcionalidades integradas como certificados SSL gratuitos, gestión de dominios personalizados, previews de pull requests y un CDN global que acelera la carga de la página a nivel mundial. A continuación, describiremos paso a paso el procedimiento que seguimos para configurar, generar y publicar nuestra landing page en Netlify, desde la creación del proyecto hasta la verificación del despliegue en producción.

## 5.2. Landing Page, Services & Applications Implementation

### 5.2.1. Sprint 1  

El Sprint 1 se centró en establecer la base de la plataforma, abordando aspectos fundamentales para la presentación inicial y la navegación. Se realizaron avances significativos en la localización y adaptabilidad a dispositivos móviles, la definición y comunicación de la propuesta de valor, y la implementación de una navegación inicial clara desde la página de inicio. Además, se priorizó la accesibilidad web y se comenzó a estructurar tanto el encabezado (con consideraciones de navegación persistente y diseño visual) como el pie de página (incluyendo enlaces importantes e información de contacto). Este sprint inicial sentó las bases para futuras iteraciones, marcando el comienzo de la construcción de una plataforma sólida y accesible.
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcCSJqCO2SEUeUnZ_d-h7CbyRXW0lRI_fl8sJ6nxuujmHHXyrgaNGfVsy1Hy_lZ6zMdtd95WQvaYRYnCAHfiW8rG8-ZLe6gw-h7qJV6cJJH2e2Txw3g37ZisU9u7mlVOg4hgJxOEQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe26_ufXBzEDIGJo2Z4lBH_9i9BCuQl8kaH-CH-oMsYPYvs5VYe4HPQ7bLoFbt1vv7NSJI5nQwYm35dpLU5kYmmOkYKv6vHZWxRx11Yt6LAstGVrJlIE94h8gAEhYN8qoN5UstYLg?key=J06Wc8-GfXXlOJgmuX32uwpk)

#### 5.2.1.1. Sprint Planning 1

A continuación se documenta la planificación del Sprint 1, que marca el inicio de la construcción de la plataforma Q2. Durante esta sesión de planificación, el equipo definió el alcance, estableció los objetivos de negocio y asumió la responsabilidad de las historias de usuario acordadas. El Sprint estará orientado a entregar una presentación inicial atractiva y accesible, con navegación básica y soporte para ARIA y descripciones de imágenes, de manera que ofrezca una experiencia clara y coherente al primer grupo de usuarios.
...
| Attendees (to planning meeting) | Jonatan Ariel Acuña Corahua, Dante Mateo Aleman Romano, Fabrizio Alessandro Contreras Peralta, Neil Aldrin Wilhelm Curipaco Huayllani |
...
A continuación se presenta la **Matriz de Liderazgo y Colaboración (LACX)** correspondiente al Sprint 1. Este artefacto identifica los tres aspectos funcionales clave definidos para el Sprint —estructura y estilos de la Landing Page, internacionalización y accesibilidad, y navegación junto a páginas de contenido— y asigna, para cada uno, un líder responsable de su ejecución (L) y los colaboradores que aportaron mediante commits y revisiones (C). Con esta visualización, el equipo obtiene mayor claridad sobre las áreas de responsabilidad y las sinergias entre sus miembros, favoreciendo una comunicación más efectiva y un seguimiento transparente de las tareas durante todo el Sprint.

| Team Member (Last Name, First Name)     | GitHub Username    | Landing Page Structure & Styles | Internationalization & Accessibility | Navigation & Content Pages |
| --------------------------------------- | ------------------ | ------------------------------- | ------------------------------------ | -------------------------- |
| Jonatan Ariel, Acuña Corahua            | JonatanFD          | C                               | C                                    | L                          |
| Dante Mateo, Aleman Romano              | zGIKS              | C                               | C                                    | C                          |
| Fabrizio Alessandro, Contreras Peralta  | Fabrizio Contreras | C                               | L                                    | C                          |
| Neil Aldrin Wilhelm, Curipaco Huayllani | Neilcuri           | L                               | C                                    | C                          |

#### 5.2.1.3. Sprint Backlog 1

El objetivo principal del Sprint 1 es establecer la presencia online inicial de Q2-Apps Web, enfocándose en la estructura fundamental de la landing page, la navegación esencial (como el header y el footer), la presentación de información clave de la compañía y la plataforma (incluyendo la propuesta de valor y FAQs), y la implementación de funcionalidades básicas de accesibilidad e internacionalización (como la adaptación a móviles y el cambio de idioma). Este sprint busca sentar las bases para una primera interacción del usuario con la aplicación, asegurando que puedan entender qué ofrece la plataforma y cómo navegar por ella de manera efectiva.

Capturas del Jira:

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcNiWRNbUa0BSw8Ru2dIyFkreim6f3PwiQQlLIaK6olIZPo4sqV1-f0bOKs0bGUmAMJbYstVNkyVJ1lDVCS2sK3UjXvllm600V0aMc_wuuLNTQr-dnCWlY8d35RSewpEUc7Vbe7mQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcTH4l7Glbz-cWqzIXqFzlPiAgYUl0rEnBAbFDTg512tX1NtJN7N3StHKvILoHyNzm0OWLQ8pw7an8QR-20vBCWw3p0N7H3U1ohvzV0Bqtur1Hd05561Arok8Sl_x29dYT-38Htig?key=J06Wc8-GfXXlOJgmuX32uwpk) 
...
| US05          | Access Image Descriptions                     | T05     | Add alt text to images           | As a visitor who relies on a screen reader, I want all meaningful images on the landing page to include clear alternative text so that I can understand the visual content. | 3                  | Dante Aleman       | Done   |
...
Durante el Sprint 1, se sentaron las bases de "Q2-Apps Web" con un enfoque en la Landing Page y las funcionalidades iniciales de la Aplicación Web. Se implementó la estructura y diseño de la Landing Page con sus primeros activos visuales, y en la Aplicación Web se progresó en la navegación principal, el header, y enlaces a secciones clave como Equipo, "Quiénes Somos" y FAQ, además de un carrusel visual. Las mejoras técnicas incluyeron internacionalización (i18n), diseño responsive básico y optimizaciones SEO elementales, siendo este desarrollo frontend crucial para la futura integración con Web Services.

| Repository          | Branch                          | Commit Id | Commit Message                                               | Commited on (Date) |
| ------------------- | ------------------------------- | --------- | ------------------------------------------------------------ | ------------------ |
| q2-aplicaciones-web | main / develop                  | 23dceed   | Feat: Add initial HTML structure for Q2 landing page         | 13/05              |
| q2-aplicaciones-web | develop                         | 20b93a0   | Feat: Add main CSS styles for Q2 landing page layout and components | 13/05              |
| q2-aplicaciones-web | feature/add-assets              | d653f25   | Feat: Add main image and css styles for Q2 landing page      | 13/05              |
| q2-aplicaciones-web | develop                         | d65da8d   | Merge pull request #1 from q2-aplicaciones-web/feature/add-assets | 13/05              |
| q2-aplicaciones-web | feature/add-faq-page            | 5a71222   | Feat: Add CSS styles for FAQ page layout and components      | 13/05              |
| q2-aplicaciones-web | develop                         | b401fe3   | Merge pull request #2 from q2-aplicaciones-web/feature/add-faq-page | 13/05              |
| q2-aplicaciones-web | feat/add-team-page              | 3a1cde8   | Feat: Update navigation links and add team page              | 13/05              |
| q2-aplicaciones-web | develop                         | 51240f5   | Merge pull request #3 from q2-aplicaciones-web/feat/add-team-page | 13/05              |
| q2-aplicaciones-web | feature/add-about-page          | 1958dd6   | Feat: Add CSS styles for Who Are We page layout and components | 13/05              |
| q2-aplicaciones-web | develop                         | 2d94267   | Merge pull request #4 from q2-aplicaciones-web/feature/add-about-page | 13/05              |
| q2-aplicaciones-web | feature/carousel-styles         | 02841df   | Feat: Add CSS styles for infinite carousel component         | 13/05              |
| q2-aplicaciones-web | develop                         | 9d03f38   | Merge pull request #5 from q2-aplicaciones-web/feature/carousel-styles | 13/05              |
| q2-aplicaciones-web | feature/add-homepage-styles     | 6688172   | Feat: Add CSS styles for homepage layout and components      | 13/05              |
| q2-aplicaciones-web | develop                         | 3ecd136   | Merge pull request #6 from q2-aplicaciones-web/feature/add-homepage-styles | 13/05              |
| q2-aplicaciones-web | feature/add-i18n-js             | 8d06665   | Feat: Add English and Spanish language support for application content | 13/05              |
| q2-aplicaciones-web | develop                         | 7f48d36   | Merge pull request #7 from q2-aplicaciones-web/feature/add-i18n-js | 13/05              |
| q2-aplicaciones-web | feature/add-language-index      | c656f1a   | Fix: Correct spelling of 'FAQ' in navigation                 | 13/05              |
| q2-aplicaciones-web | develop                         | 9921b70   | Merge pull request #8 from q2-aplicaciones-web/feature/add-language-index | 13/05              |
| q2-aplicaciones-web | feature/update-navigation-links | 2e8c5e3   | Feat: Add meta tags for SEO enhancement on the team page     | 13/05              |
| q2-aplicaciones-web | develop                         | 3cdb61c   | Merge pull request #9 from q2-aplicaciones-web/feature/update-navigation-links | 13/05              |
| q2-aplicaciones-web | feature/add-i18n-support        | 9c0e61c   | Refactor: Update header structure and navigation for consistency acro... | 13/05              |
| q2-aplicaciones-web | develop                         | 8b797fb   | Merge pull request #10 from q2-aplicaciones-web/feature/add-i18n-support | 13/05              |
| q2-aplicaciones-web | feature/add-language-script     | 057cb2d   | Feat: Implement internationalization support with language files and... | 13/05              |
| q2-aplicaciones-web | develop                         | b862eea   | Merge pull request #11 from q2-aplicaciones-web/feature/add-language-script | 13/05              |
| q2-aplicaciones-web | feature/add-menu-styles         | ed70cff   | Feat: Enhance responsive design for FAQ and homepage, including mobil... | 13/05              |
| q2-aplicaciones-web | develop                         | f2d3b08   | Merge pull request #12 from q2-aplicaciones-web/feature/add-menu-styles | 13/05              |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcCLWanjFa9-RJNhDT5qh9FQ53w-lHYbjQ4QPnlmfDkLdm1lRsgJEs5ZQCe9julDnxeIOpfvhyd_3ZMTiVOSDtZEJEZ83JWbrkJv2dnzsawop91m0Z2KbajfC1jhbUKL3I4Au06Mw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXct-TEZmiwjIvpe-CSiSuAflJEE5wUenwnqk4mYWvIMtQxVU7hD75N23ftzeB-cx0blKe7IAcR5dCnllhGsE_b17FaGWJoiEmOuGdrMhvZb2Bb_p1-5a-skLHtSWeDpLBF4cNwsGg?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXddwy_rBx3-YWZ-LnTp90zgC6LfuDBRGArdWfbCfDGZnwj-0MuCOVFSUTxUQcwe3UWnJsfGJbAbB24IXKtlRRvno1qfQI4QtvKxwANhlUMY3mpPjhvVQ1uNXVtUfFOaUvAJkgH0eQ?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfG2cNE38dwbgimfe9KlEY19OjVddqprrltw1-C6WDHF6IsOsZnoCVQH6_VgKezdFJgpdMzdcAlOxUFDdd2hT9R3D2ossSqEGYWVElPIiNbs1YOZ3_vYf9YTGssjobHVpZAPbZoUg?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf3ugMGe676sn6kTQmZivPKvCTop_FnwMvI5NxJjFAeKLo7yRHCtWDFhEUElxbFvCUts8TV4IYUcRjPGMg24L0pleYcBprvF5yuZyi9GEplCBbHXs84KizKi3LJJ-3hfygWRYyApQ?key=J06Wc8-GfXXlOJgmuX32uwpk)
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfnH5DlN4F9Ezwaekcpl1Xkaz3jHiej-KgLEARty-SlKhkL1HTo_oETkS8x2-wplD4Y33l1vDQuYEsKY5nFIp_pLXY4gsODiBjopo2Co4CnXfOZOaaSnR5QMOlBrrk6x4M3Pthctw?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
Durante el Sprint 1, el equipo trabajó de manera coordinada en las tres líneas principales de producto: **Landing Page**, **Web Applications** (páginas de contenido y navegación) y **Web Services** (soporte a accesibilidad e internacionalización). A continuación se detalla cómo se organizaron las actividades de implementación, se analizan las métricas de colaboración en GitHub y se muestran capturas de los analíticos de commits por miembro y por producto.

1. Organización del trabajo

   

   - Cada miembro asumió responsabilidad de un aspecto clave (estructura, i18n/accesibilidad y rutas/páginas), con líderes definidos para coordinar entregables y revisiones de código.

     

   - Se crearon ramas de características (feature/...) para aislar desarrollos y permitir revisiones en pull requests antes de mergear a develop.

     

   - Las tareas se distribuyeron de acuerdo con los User Stories planificados, garantizando que todos contribuyeran en cada línea de producto.

     

2. Métricas de colaboración en GitHub

   

   - **Distribución de commits por miembro:** muestra cómo cada integrante aportó al código base, con especial atención a los “features” y merge requests aprobados.

     

   - **Commits por área de producto:** ilustra el esfuerzo invertido en Landing Page vs. páginas de contenido vs. i18n y accesibilidad.

     

   - **Pull Requests revisadas y aprobadas:** se contabilizan las PRs creadas, revisadas y fusionadas, evidenciando revisiones cruzadas entre compañeros.

     

3. Participación de equipo en cada producto

   

   - **Landing Page:** diseño y estilos base, assets y carrusel (liderado por Neilcuri con apoyos de todos).

     

   - **Web Applications:** páginas “About”, “Team” y “FAQ” más configuración de rutas y navegación (liderado por JonatanFD).

     

   - **Web Services (i18n & accesibilidad):** integración de idiomas, ARIA y descripciones de imágenes (liderado por FabrizioContreras).

     

#### ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfF96ho6g9RGzYwYP8XEIjjUnwlEqWGMknn7xLsnOmz1h_iQK4LFcG1KC-Wk1u6qyQakIqzWTNEdfWSytDpR4D2DhCyMq5_voRt9xFPQmp4gtLpdhlYRtVZX1ycU7tjleLZRKkf?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdM_jRfsKzeBh-3f2sXDpOKoICDsCOJCST18cbV4XKPV7XQq_gZ0xSdjH3E7HvOs9C6l181mDLkSs4ztzVbAoWHJoz9RozEoq9ISmXm0iXiQA02fWcl86n0fLdfeS23hulGiPALwg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe34AI6hEFJ8BPg1EHBQguHo-1veXXxCI2hiIPXpvMkQFrosCMdZIfo9t48L2PHnW2346JR1UItuElacYUhbHktFShrSj6tDdobb4HTDjs3W0tzwI-elW7NteLhmKSw7tSAY6ZuzA?key=J06Wc8-GfXXlOJgmuX32uwpk)



### 5.2.2. Sprint 2

En este Sprint 2 se han mejorado las funcionalidades anteriormente creadas en el sprint anterior, asegurando su estabilidad y prioridad ante las necesidades de nuestros usuarios. Además, de la corrección de errores. A parte de implementar nuevas funcionalidades para el proyecto. 

Durante su desarrollo del Sprint, se han mantenido las reuniones diarias para evaluar el progreso, identificar obstáculos y ajustes según sea necesario. Al final del Sprint, entregaremos una nueva versión del producto, con mejoras visibles y funcionalidades adicionales, acercándonos cada vez más a la visión final. Con el fin de mantener una estructura sólida y flexible para nuestro público objetivo.



#### 5.2.2.1. Sprint Planning 2

El 10 de mayo de 2025, el equipo de desarrollo de QURI se reunió de manera virtual a través de Google Meet para dar inicio al Sprint 2, correspondiente al periodo del 28 de abril al 22 de mayo. Bajo la coordinación de Jonatan Ariel Acuña Corahua y con la participación de Dante Mateo Alemán Romano, Fabrizio Contreras Peralta y Neil Curipaco Huayllani, en esta sesión de planificación revisamos los resultados y aprendizajes del Sprint 1, definimos el objetivo de este nuevo Sprint y seleccionamos las historias de usuario prioritarias. Con un enfoque claro en la estructura de navegación interna, las herramientas de diseño de productos y la gestión de “blueprints” de diseño, acordamos los criterios de éxito, validamos estimaciones por un total de 74 puntos de historia y establecimos las bases para una iteración eficiente y de alta calidad.
...
El Sprint Backlog 2 corresponde a la planificación e implementación de las funcionalidades iniciales del proyecto TeeLab, centradas en el desarrollo de la landing page. 
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcqZ2Aoe4MW9eHaYg6BroO1L5JvZPGKpQLSqJl48MXEs0gF9OnjLl-LfrRsLkV583QS1PrZE0B0wuHFrgVK2xinv4ODdW2X3tuHTMot6uT0eaCjFxRotw_7KmeoOtnpspnWT75E?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc42j4i4llQbMgIn6L4WfegjLm7GN5CqscZ5azms-xAn3WI_wbwsMDny9zrBac_PFR4hAYSm3dPtiPA1oi36o8_sqSPrsLVaXsgV-W1CQOi-_HpnXEAFOMH4lXJcE3v1Jwqx66GHw?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
| US12              | Layer Ordering Control in the Design Lab        | T12         | Reorder layers in design            | As a user, I want to control the order of layers in my design. | 5                      | Jonatan Acuña      | Done       |
...
| US17              | Load a saved product design or blueprint        | T17         | Load existing design                | As a user, I want to load a previously saved design.         | 5                      | Neil Curipaco      | Done       |
...
| US23              | Support publishing of product designs           | T22         | Enable publishing support           | As a user, I want the system to support publishing workflows. | 3                      | Neil Curipaco      | Done       |

#### 5.2.2.4. Development Evidence for Sprint Review

Durante el Sprint 2, se crearon y utilizaron múltiples ramas de desarrollo, cada una correspondiente a una historia de usuario o tarea específica asignada dentro del backlog del Sprint. Estas ramas siguen el estándar de nomenclatura propuesto por GitFlow, utilizando el prefijo feature/ seguido de un identificador claro de funcionalidad, por ejemplo:
...
| **Repository**              | **Branch**                                | **Commit Id**   | **Commit Message**                                           | **Commited on (Date)** |
| --------------------------- | ----------------------------------------- | --------------- | ------------------------------------------------------------ | ---------------------- |
| q2-aplicaciones-web/web-app | release/1.0.0                             | 198ae8f         | Merge pull request #8 from q2-aplicaciones-web/feature/add-images-to-… | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | 6ed2939…198ae8f | feat: adding the background                                  | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-images-to-design-lab-projects | 6ed2939…f9e467b | Merge pull request #7 from q2-aplicaciones-web/feature/add-image | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-images-to-design-lab-projects | 6ed2939         | Merge pull request #7 from q2-aplicaciones-web/feature/add-image | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | 352f8f1…6ed2939 | feat: add tshirt-outline SVG graphic                         | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-image                         | 352f8f1…6ff20e0 | Merge pull request #6 from q2-aplicaciones-web/feature/add-route | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-image                         | 352f8f1         | Merge pull request #6 from q2-aplicaciones-web/feature/add-route | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | 8e3a4c3…352f8f1 | feat: add router configuration with routes for home, dashboard, desig… | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-route                         | 8e3a4c3…605abf0 | Merge pull request #5 from q2-aplicaciones-web/feature/add-public-p | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-route                         | 8e3a4c3         | Merge pull request #5 from q2-aplicaciones-web/feature/add-public-p | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | 6310b92…8e3a4c3 | feat: add new components for options panel and project detail pages | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-public-p                      | 6310b92…67f18ce | Merge pull request #4 from q2-aplicaciones-web/feature/add-public-pages | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-public-p                      | 6310b92         | Merge pull request #4 from q2-aplicaciones-web/feature/add-public-pages | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | b8881ed…6310b92 | feat: create home component with initial setup               | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-public-pages                  | b8881ed…c3d88ad | Merge pull request #3 from q2-aplicaciones-web/feature/add-services | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-public-pages                  | b8881ed         | Merge pull request #3 from q2-aplicaciones-web/feature/add-services | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | 2534dcc…b8881ed | feat: implement ProjectService for managing project-related API inter… | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-services                      | b4d30f2…b4600ef | Merge pull request #2 from q2-aplicaciones-web/feature/add-js-logic | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | b4d30f2…2534dcc | Merge pull request #1 from q2-aplicaciones-web/feature/add-designlab-… | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-services                      | b4d30f2         | feat: add Zod schemas for project, canvas, layers, text, and image op… | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-js-logic                      | b4d30f2…fc5638d | Merge pull request #1 from q2-aplicaciones-web/feature/add-designlab-… | 13/05/2025             |
| q2-aplicaciones-web/web-app | feature/add-js-logic                      | b4d30f2         | Merge pull request #1 from q2-aplicaciones-web/feature/add-designlab-… | 13/05/2025             |
| q2-aplicaciones-web/web-app | develop                                   | d73a852…b4d30f2 | Share feedback about this page                               | 13/05/2025             |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXe434BLWSoxabXrc9jneni02ny0JyYo8Gmu8FVQ7BlFtxPXO5zouBD6dPP7HTo0DaGuQHxwrhTPzATDGjcngLvoqA4UrJCAab41q4pEMkY3o0D-4jvVnhSTUUzwStzgeYBhzDxqGw?key=J06Wc8-GfXXlOJgmuX32uwpk)

Editor de Texto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfCn6cI1ME5cs0Alk-K-E4Lajfa5fyxfQvioiY_GJuajVC--7M5KHFIAENpg2Ngp4pEsrQmXknTrOaaG8Ea6w249kGI0um7rQqMP5PXdQ094I8zU4EZM3XApwcaRFhgfPEAfMzX5Q?key=J06Wc8-GfXXlOJgmuX32uwpk)

Editor de Imagen	
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXezbNgmal7PZF39H3fIjRDGIE7HMMbxhwliMhW_gWmGjfkF9VlELkJuZFNA2tmwAD8piLpuTyB1LBHsxEpWKcrsHtZNg5enKU0dBQAVfevTDkbBYFRVlVVtTXWPgIOhoCnclLk0yw?key=J06Wc8-GfXXlOJgmuX32uwpk)Link del video:
...
Esta sección resume los procesos de despliegue llevados a cabo durante el Sprint 2. Durante este sprint, nuestro enfoque principal fue establecer el despliegue fundamental para nuestras Aplicaciones Web, específicamente para la navegación interna y las interfaces de diseño de prendas. Esto implicó la configuración inicial del proyecto en un proveedor de la nube y asegurar su publicación exitosa.

Para facilitar el despliegue continuo de nuestra aplicación web, utilizamos Netlify como nuestro proveedor de la nube. Se creó un proyecto y se vinculó a nuestro repositorio de desarrollo para permitir despliegues automáticos al subir código.

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfa2VTeVf61fiFmh2q5CPj0xekGsd2HICJyQIByNtFqJvqg0C9emr6YCTiUa-Jf7x0NyB59ihYArjUml9jMXOuI_XzIx_8nTX_aUXt3q2mSM7aGkmj81S4epYad7o866C2BU8Hp9Q?key=J06Wc8-GfXXlOJgmuX32uwpk)

Captura de la Landing Page en producción, accesible en: 
https://q2-design-lab.netlify.app/home

#### 5.2.2.8. Team Collaboration Insights during Sprint

1. Organización del Trabajo

Durante el Sprint 1, el equipo adoptó un enfoque coordinado y estructurado para abordar las tres líneas principales de producto: Landing Page, Web Applications (páginas de contenido y navegación) y Web Services (soporte a accesibilidad e internacionalización). La implementación se organizó de la siguiente manera:

- **Responsabilidades Clave:** Cada miembro del equipo asumió la responsabilidad de un aspecto fundamental, ya sea la estructura general del proyecto, la internacionalización (i18n) y accesibilidad, o la configuración de rutas y páginas. Se designaron líderes para coordinar los entregables y asegurar revisiones de código exhaustivas.
- **Desarrollo Aislado con Ramas de Características:** Para mantener la estabilidad del código base y facilitar las revisiones, se utilizaron ramas de características (feature/...). Esto permitió que cada desarrollo se aislara, y los cambios se integraron en la rama develop solo después de pasar por un proceso de revisión de Pull Requests (PRs).
- **Distribución de Tareas:** Las tareas se distribuyeron estratégicamente en función de los User Stories planificados, garantizando que todos los miembros del equipo tuvieran la oportunidad de contribuir significativamente en cada una de las líneas de producto.
- Métricas de Colaboración en GitHub

La colaboración en GitHub fue un pilar fundamental de este sprint, reflejando el trabajo en equipo y la calidad del código. A continuación, se detallan las métricas clave:

- **Distribución de Commits por Miembro:** Aunque no se muestran los analíticos de commits por miembro directamente en la imagen proporcionada, el historial de Pull Requests y los mensajes de commit indican una contribución activa de todos los integrantes. Los "features" y las solicitudes de fusión aprobadas son un claro indicio de la participación individual en el código base.

- **Commits por Área de Producto:** Los mensajes de commit, como "feat: adding the background", "feat: add tshirt-outline SVG graphic", "feat: add router configuration...", y "feat: implement ProjectService...", demuestran el esfuerzo distribuido en las diferentes áreas:
  - **Web Applications:** Commits enfocados en la creación de páginas de contenido y la configuración de rutas (ej. "feat: add router configuration with routes for home, dashboard, desig...", "feat: add new components for options panel and project detail pages", "feat: create home component with initial setup").

- **Pull Requests Revisadas y Aprobadas:** El registro de Pull Requests (PRs) es un testimonio de la colaboración activa y las revisiones cruzadas. Se crearon múltiples PRs para cada característica, las cuales fueron revisadas y aprobadas por los compañeros, asegurando la calidad y la coherencia del código. Por ejemplo, se observa:
  - Merge pull request #7 from q2-aplicaciones-web/feature/add-image
  - Merge pull request #6 from q2-aplicaciones-web/feature/add-route
  - Merge pull request #4 from q2-aplicaciones-web/feature/add-public-pages
  - Merge pull request #3 from q2-aplicaciones-web/feature/add-services
  - Merge pull request #2 from q2-aplicaciones-web/feature/add-js-logic
- Participación del Equipo por Producto

La participación del equipo se distribuyó de la siguiente manera:

**Web Applications:** JonatanFD lideró el desarrollo de páginas clave como "About", "Team" y "FAQ", además de la configuración de rutas y la navegación del sitio.

#### ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeyDQ1ORNmusW3E8e4scXDtCSn1EhHGcP3yo37xHDaGWixFt5pk96J_-PCcjbwFqYEQHTarfTlXcSHMHTmxcel7xFL5HJT6OeWhbI_UCfp0vBNsOHxBypw2vD6tKplI0gkNdd-emg?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcPKMVgCgaXoNOdlmp63pUrr3nj05zyaW5YJ7cfv5-1QMoeu99EfI1mejHe02BEEJQDsQs5FMuBy8qkMnvzeTlWDhub7FEB0Rm3Z9kzPJQbF9_IU1byIKYJGrTLve63mIQsNMjIzA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
El 19 de mayo de 2025, el equipo de Q2 se reunió virtualmente a través de Google Meet para dar inicio al Sprint 3, una iteración clave enfocada en consolidar los módulos restantes de la aplicación web y desplegar el Web Service API en producción. Bajo la coordinación de Jonatan Ariel Acuña Corahua y con la participación de Dante Mateo Alemán Romano, Fabrizio Alessandro Contreras Peralta y Neil Aldrin Wilhelm Curipaco Huayllani, se revisaron los avances del sprint anterior, se definió el nuevo objetivo y se acordaron las historias de usuario prioritarias. Con un enfoque centrado en la personalización, gestión de pedidos y robustez del backend, el equipo estableció criterios de aceptación claros, validó estimaciones que sumaron 292 puntos de historia y reafirmó su compromiso para entregar una experiencia fluida, accesible y completamente funcional para los usuarios de TeeLab.
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc72xvQbWP5bx5kdj8vHvuW1pLgxK4FpAAHBFOxZbP4INxo2fpWaOWloPL5Jp5hxkpY2xX6qh0-CBqYmr_xi2Wz2fccYvCOsKvMXWWN5Rd8Ttqw_Z9yN-f52EXj2NJCWuzWVVdonA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcQgCr00xTFJbZlKpd6LbOL3K7FPYmTbEgVHLJANIkJHsthaYY8pN2_C905wDGMhnGaM1WkOzx1Ql8n5XtioF9_eeE-kTpL2D82gYjTosRjIC__DI94W5GUXHvKOpRTjm2SeC5c1A?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
| US31          | Invalidate Tokens and Clear Session Metadata           | T31     | Invalidate tokens on logout         | As a user, I want my session to be fully cleared on logout.  | 2                  | Jonatan Acuña      | Done   |
| US32          | Enforce Secure Data Transmission and Encryption        | T32     | Enforce HTTPS and encrypt data      | As a user, I want all data to be transmitted securely.       | 2                  | Neil Curipaco      | Done   |
| US34          | Implement Temporary Token for Password Reset           | T34     | Generate temporary reset token      | As a user, I want to reset my password securely.             | 2                  | Neil Curipaco      | Done   |
...
| US47          | View Estimated Delivery Time                           | T47     | Show estimated delivery time        | As a user, I want to know when my order will arrive.         | 2                  | Jonatan Acuña      | Done   |
| US48          | Track production progress in dashboard                 | T48     | Display production progress         | As a user, I want to track production status in real time.   | 2                  | Jonatan Acuña      | Done   |
| US49          | Access the administration panel                        | T49     | Open admin panel                    | As a manufacturer, I want to access the admin panel.         | 5                  | Fabrizio Contreras | Done   |
...
Durante el Sprint 3 se avanzó en la implementación de la solución a través de múltiples commits en el repositorio principal q2-aplicaciones-web/web-app y q2-aplicaciones-web/service. A continuación se presenta una tabla detallada con cada cambio significativo, su rama de origen, identificador, mensaje y fecha de commiteo. Estos commits reflejan el progreso en los componentes Access Security, Analytics , Design-lab, Orders Fulfillment, Product Catalog y User Management .

Web app

| **Repository**              | **Branch**                  | **Commit Id** | **Commit Message**     | **Author** | **Committed on** |
| --------------------------- | --------------------------- | ------------- | ---------------------- | ---------- | ---------------- |
| q2-aplicaciones-web/web-app | feature/add-manunacter-a…   | 2910512       | Merge pull request #21 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/fix-home-and-rol    | 1222f27       | Merge pull request #19 | Neilcuri   | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-to-cart-from…   | 2cb505d       | Merge pull request #18 | Neilcuri   | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-assemblers-a…   | 3c722de       | Merge pull request #17 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | refactor/product-catalog-bc | f947c66       | Merge pull request #16 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-shopping-car…   | b20c6c9       | Merge pull request #15 | Neilcuri   | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/project-card-add…   | 0bfffd5       | Merge pull request #14 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-product-catalog | dc12a9d       | Merge pull request #13 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-manufacturer…   | 579d366       | Merge pull request #12 | zGIKS      | 18 de junio      |
| q2-aplicaciones-web/web-app | feature/add-shopping-car…   | ca58e31       | Merge pull request #11 | Neilcuri   | 18 de junio      |

Web service

| **Repository**              | **Branch**                                    | **Commit Id** | **Commit Message**                                           | **Author**  | **Tiempo**  |
| --------------------------- | --------------------------------------------- | ------------- | ------------------------------------------------------------ | ----------- | ----------- |
| q2-aplicaciones-web/web-app | feature/add-delete-layer                      | f4b58a6       | feat: update layer classes and endpoints to allow nullable fields and… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/add-design-lab-endpoints              | b9a55d3       | feat: update CreateImageLayer and CreateTextLayer commands to use Pro… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/add-design-lab-endpoints              | 4bdd676       | feat: refactor CreateProjectCommand and related classes for improved… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/add-design-lab-endpoints              | 0cce77a       | feat: implement CreateProject command and resource with validation | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/add-design-lab-endpoints              | a7efa8d       | feat: update endpoint tags for Products and Comments controllers to r… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/add-jpa                               | c67e65b       | refactor: improve formatting and consistency in JPA entity classes and… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/id-handling-improvement               | 4519876       | refactor: apply code style and formatting improvements across analyti… | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/fix-order-fulfillment-bounded-context | adbcfcc       | Merge branch 'develop' into feature/fix-order-fulfillment-bounded-context | JonatanFD   | 18 de junio |
| q2-aplicaciones-web/web-app | feature/refactor-acl-product-catalog-domain   | 0252336       | refactor: update value object documentation for ManufacturerId | fabriziocpa | 18 de junio |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXecu254Rjs6qNFauz4VUYMUJ234HOD6b1mz4fXF2-xX49LWieQw8sq9tnro5MY2UfZ1pjV7ArHmQfc7wUSokuIeIQ7_8mxbrbI11Ooa_BMl3Btjh7gVdYX9lM7H10xeHnA9mKDbHQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfMCY5ctyjb6Hv-3kKxEVTj7aIDdbYybix1p77atIWDdmNpDwrLif-0VJHa6j1Yj3_RW2f8ZOVQYS_Nf1N95ph_IX5ISacv8VlGn_5TrKbJUxRT69Yx95_HWV132uhjc9qL5hxn?key=J06Wc8-GfXXlOJgmuX32uwpk)![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdcSlRm2LTSNjKiFp4kfgPOGqrhq1Wv6ITa2-Ixz4HaxbWyKnRz5nuQ19F7D2wuocZ8iFqELWl-hOBtvRhXPoWw9Yap0Jl7SZ0xMPJgcZ5Uk8B2A2718QfWac82nANEVGiP_5DDvQ?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
| ------------------ | --------------- | ------------------------------------------- | ----------------------------- | --------------------------------- | ------------------------------ |
| /api/products      | GET             | Obtiene la lista de productos disponibles   | ?search=camiseta (opcional)   | GET /api/products?search=camiseta | 200 OK - Lista de productos    |
...
| /api/cart          | POST            | Añade un producto al carrito                | body: { productId, quantity } | POST /api/cart                    | 201 Created - Producto añadido |
| /api/cart          | GET             | Obtiene el contenido del carrito actual     | Ninguno                       | GET /api/cart                     | 200 OK - Carrito del usuario   |
| /api/manufacturers | GET             | Lista todos los fabricantes disponibles     | Ninguno                       | GET /api/manufacturers            | 200 OK - Lista de fabricantes  |
| /api/orders        | GET             | Lista las órdenes realizadas por el usuario | Auth header (token)           | GET /api/orders                   | 200 OK - Lista de órdenes      |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeXTFX2IbC6l8HA6we3Ho8OrXOqdGGwifIqwQqPRARSNSgzbu9H-2TJDuouQubW8v-3xKjpe31uICqItJO2FwPzURi8TAvCc_0hpuERZvfD6zqQmIyCg2fAdsMfxqQ12VHoTgBM?key=J06Wc8-GfXXlOJgmuX32uwpk)

Creación del proyecto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeiHcjcKokLrTyjHeADcVY4kFKH9Wltpb8jNxu0yp-kWOEdgpIisr1iHrYu6yxz13TLdA0148DJCPRFUlyQ0eWhpWFY8ZZvU4vG0cKmg1rcJUZCsaoFzeGLZUBbfY7BhsTMX7oc?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc5LOvlozQrC2T6y992AsdFjFRHK5QiSWKFGAbuuDKnVule6jU40IMR-OwaGxjm-geM42uvwSht2TELD1TpDPYcYIiQvNQXskTQqKk3zvGnpuwOU8_UNC66mVb1uUk9HDUSQqNn_g?key=J06Wc8-GfXXlOJgmuX32uwpk)

Consulta de proyectos por usuario

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfosx7NzF915HulKD34Z5-2FqLmNZT-j4bmYyxsPbJGs6FJwzljjlI1OcbyVa02BKMBZBqPB_qqlY8pfGH-eYg4EGi8r0LD8IDynSYHaQgv37tSGs_Femtm6TWDvymFpQdJpr0VkA?key=J06Wc8-GfXXlOJgmuX32uwpk)

**Endpoints de project layer**

**![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd6nEfD29A0gllI6y0KG_sD2a2jL56s2ChRSBPGBvF64WfeBpgrLcyrjSqscdWW3yKUykIodPTBv44XPwZAnUec5I5Az02pB4WLpIxCqjFOg_tDgzy2wEM5K9152twzxXSu8u0u?key=J06Wc8-GfXXlOJgmuX32uwpk)**

Agregar nueva capa de texto al proyecto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcQKABsFpjFY_KVhciTs2gQudy2W6MKRPAZ6cp4cz30v7alud_f0hjlgjdEwCnm8tddcQkQVRRRc3NKKOuT0M1FbVAlqIt7YiCid4z_-gwRPhfS5yovoWfaz7Jgemof7FW38A3y7g?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc-QWiK9_Xja1b_UJoUQmYRTm8NunI67ZSu-pKif2jYTQYnUW4rUz4VxVQOTShY11pWPiFl-jQZh31RFOQ30QU_EzSg_20psGwr_m7Dxvi1uikg_eexIZuoSNlqXQew5N5W1EzcFw?key=J06Wc8-GfXXlOJgmuX32uwpk)

Agregar nueva capa de imagen al proyecto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfdmS3DwEgSQM4j5GiOdwWQ2r6uLQizwMvwAtOYWPUV49pk2Pnu82MQBgv7rjrZguTaHt1HQTMmc13-16eVc4DB60TeZ9Qi00LSUtYV99cu3dxnpMApc5C-FREIC_A3t4s315YN2Q?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfYArR4tioyMs8TqvvYO-Ec40mYhxEZHIIS4Qo9pldkxOnXsgM7Krs4vfI3QytaDkC7OrDqpNeKRNVxH2zMa653K-7dNNSyEDFSkzKnnDqDig7_YvjN03esVyHmUuntfu7U77y8Kg?key=J06Wc8-GfXXlOJgmuX32uwpk)

Eliminar capa del proyecto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfXVSr5xEw6wPPxV5l4uw56ombAZskniwrYKW3G4kalAUvj5rptXCLR-EsVDOSRiT6vaH0FL4aEAwGasUhy6hGMfWuoPwLWqBF8NSHkxMP1p_tiRXvJK4uFC9W8rQM3M_2NF5sbaA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd9xtzuEDa2En3milfCKmO8xl8HUKY8UKS4dacskBySGgvBjUXm4ltujQO4xHEsxHcYw8TfoKAHBr8qoDyvYcynsH_5RIhHOhwTst7HZeDg3bGk4P3Nt9IjdgesVDJjLTeEdTcdtA?key=J06Wc8-GfXXlOJgmuX32uwpk)

Link del repositorio web service https://github.com/q2-aplicaciones-web/web-services
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfQTVnNSjoUDFGHMhnkBUj7r_KfjgK4RLo2zSrTl-eksDYzvAX6KUOFFt9GSSlkOze9m5rYnS2Kh2XBrXrN8u1qJC5wqbCrk-m1rwRCay-vQA0O93PqrXgzp-0k6uiQpQ5gmNfYpA?key=J06Wc8-GfXXlOJgmuX32uwpk)

Link del deploy del web service:

https://web-services-1-cads.onrender.com/swagger/index.html
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdvFbU-tiHdCPl_kIcDgxR8jfmnqGQB6SuW3eZoT_gGAiz0BgoG1DH3W_IyBQycwUmtDzEESdcpflKWU2mkNezUXCcey0-0Pro7jfnoXXgMQpk87cGL5sjm4x4VOWILGQk0HRbg9A?key=J06Wc8-GfXXlOJgmuX32uwpk)

Captura de Web Service

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdHsg0-ovaOHC2MRrwGQBwvL6M0tzfTN3evjhB5xMzVzJ8Db83qkdUZJqbvFAK46nwtfs-KHmKHJPXzLusYnHUe0waff40W8s2GigDWfyV-d53siw004qyI2Qd6aTApqK3eKIdS0g?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
El 28 de mayo de 2025, el equipo de desarrollo de Q2 se reunió de manera virtual a través de Google Meet para dar inicio al Sprint 4. Bajo la coordinación de Jonatan Ariel Acuña Corahua y con la participación de Dante Mateo Aleman Romano, Fabrizio Alessandro Contreras Peralta, Neil Aldrin Wilhelm Curipaco Huayllani definimos el objetivo de este último Sprint y de implementar la correcta sincronización de los tres productos landig page, web application y web service. Con un enfoque centrado en la personalización, gestión de pedidos y robustez del backend, el equipo estableció criterios de aceptación claros, validó estimaciones que sumaron 60
...
| Location                        | Google Meet                                                  |
| Prepared By                     | Jonatan Ariel Acuña Corahua                                  |
| Attendees (to planning meeting) | Jonatan Ariel Acuña Corahua, Dante Mateo Aleman Romano, Fabrizio Alessandro Contreras Peralta y Neil Aldrin Wilhelm Curipaco Huayllani |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcM_NuuL7FIMcF51z79tcGjL9PXsGBhWGkTs05ym_clO7SGpBLes2Knf59fe6ISpWZPN4UO3uF6Jj0ga87tC7BUrziDIEkIWsGD0Lr9ead5oeS-rMHRtPWu6bPebnQCWIEI72xouw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcICTkAcLyyhZJvCsNMTj9dxIgC21F5jrD5Ru3DGPpK_PscTnT8v0QuDuT95BH47UlC7WKTw1uJgXkfnGrNZpekoi4AMj8T33Lsf0Eyy8JGP2RMXeicpdaZmALpXenR1MBGYm6lAw?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
| US39          | Enter and Confirm Shipping Details                         | T39     | Enter shipping info       | As a user, I want to enter and confirm my shipping details.  | 3                  | Fabrizio Contreras | Done   |
| US40          | Validate and Store Shipping Information in Order           | T40     | Validate shipping info    | As a user, I want my shipping info to be validated and stored. | 2                  | Fabrizio Contreras | Done   |
| US41          | Display final order summary to the customer                | T41     | Show order summary        | As a user, I want to see a summary of my order before confirming. | 2                  | Fabrizio Contreras | Done   |
...
| US51          | View assigned orders in the manufacturer panel             | T51     | View assigned orders      | As a manufacturer, I want to see my assigned orders.         | 5                  | Neil Curipaco      | Done   |
| US52          | Update the production status of an order                   | T52     | Update production status  | As a manufacturer, I want to update the status of an order.  | 5                  | Fabrizio Contreras | Done   |
| US53          | Upload Production Reports                                  | T53     | Upload production reports | As a manufacturer, I want to upload reports for completed orders. | 2                  | Fabrizio Contreras | Done   |
...
| US59          | Bind language selector to i18n module                      | T59     | Connect language selector | As a user, I want the language selector to switch the app language. | 5                  | Fabrizio Contreras | Done   |
...
| **Repository**              | **Branch**                                                   | **Commit Id**                            | **Commit Message**     | **Author**  | **Committed on** |
| --------------------------- | ------------------------------------------------------------ | ---------------------------------------- | ---------------------- | ----------- | ---------------- |
| q2-aplicaciones-web/web-app | refactor(home): improve code formatting and structure in HomeComponent | 52dd57712bb36db8b0bf513f58aee0b3520f3930 | Merge pull request #41 | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Release/2.0.0                                                | 7d3f6ff22dc62c2dbf8073d2023d2a4c8292b3c1 | Merge pull request #40 | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/add api config                                       | 546cbe424c99d7b58407964c7ca1b8f1d506a879 | Merge pull request #39 | zGIKS       | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/add manufacturer form                                | 70512e46f80a44b122bbbee53b3a452b15aec976 | Merge pull request #38 | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/add order fulfillment                                | ada5617189547032e874e31118964240b9ea37a7 | Merge pull request #37 | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/add stripe                                           | 74e9d39683eabdd04943bc70f17e5979f3196f7d | Merge pull request #36 | JonatanFD   | Jul 5, 2025      |
| q2-aplicaciones-web/web-app | Feature/fix design lab services                              | 106b814a6645278babafe341e48fa27b52913414 | Merge pull request #35 | JonatanFD   | Jul 5, 2025      |
| q2-aplicaciones-web/web-app | Feature/fix design lab                                       | ac4b91cce6e2d108ccf147f8a252d0ab423611fd | Merge pull request #34 | JonatanFD   | Jul 5, 2025      |
| q2-aplicaciones-web/web-app | Feature/add i18n                                             | bdca06062bfa3211356dbd90462541fafc609015 | Merge pull request #33 | JonatanFD   | Jul 4, 2025      |
| q2-aplicaciones-web/web-app | Feature/refactor canvas edit                                 | 7c123dff2e294b43c5dc6860f61e22d00bc7a72b | Merge pull request #32 | Neilicuri   | Jul 4, 2025      |
| q2-aplicaciones-web/web-app | Feature/refactor design lab service                          | bcd0f990004386423f8765c2d7b424ad7731a1be | Merge pull request #29 | Neilicuri   | Jul 3, 2025      |
| q2-aplicaciones-web/web-app | Feature/add profile view                                     | cc2cf99644fef8a26245f7ed40103c556611daab | Merge pull request #28 | JonatanFD   | Jul 3, 2025      |
| q2-aplicaciones-web/web-app | Feature/add authentication section                           | e8b095ba818032446abb13458f1cf94ac1b486d3 | Merge pull request #27 | Neilicuri   | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | feat: Update project details and preview attributes for consistency a… | 2469450b7ebb7ed2de12c6d55cef5e767ce87b24 | Merge pull request #26 | JonatanFD   | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Merge pull request #24 from q2-aplicaciones-web/3.0.0        | b92a0378ae3857b993aedea99edc3f85797ef08a | Merge pull request #25 | JonatanFD   | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Release/3.0.0                                                | ec8a86e6386d6c63dffb6030e18e0bf16d5bc891 | Merge pull request #24 | zGIKS       | Jun 19, 2025     |
| q2-aplicaciones-web/web-app | Feature/fix design lab schema                                | 7d2d43a45c1ed25b92e6fde75efd96c451e86c70 | Merge pull request #23 | zGIKS       | Jun 19, 2025     |
| q2-aplicaciones-web/web-app | Feature/refactor order processing                            | 1b52446276338093dec9adfc312257072fa648ed | Merge pull request #22 | fabriziocpa | Jun 19, 2025     |

**Web Service**

| **Repository**              | **Branch**                                                   | **Commit Id** | **Commit Message**                                           | **Author**  | **Committed on** |
| --------------------------- | ------------------------------------------------------------ | ------------- | ------------------------------------------------------------ | ----------- | ---------------- |
| q2-aplicaciones-web/web-app | Release/2.0.0                                                | f97ab7c       | Merge pull request #57 from q2-aplicaciones-web/release/2.0.0 | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/fix fulfillments items endpoints                     | e8754c6       | Merge pull request #56 from q2-aplicaciones-web/feature/fix-fulfillments-items-endpoints | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | Feature/add stripe service                                   | 2e75aa4       | Merge pull request #55 from q2-aplicaciones-web/feature/add-stripe-service | JonatanFD   | Jul 6, 2025      |
| q2-aplicaciones-web/web-app | fix: update authentication endpoint path for improved security | f6dc1e1       | update authentication endpoint path                          | JonatanFD   | Jul 5, 2025      |
| q2-aplicaciones-web/web-app | Feature/refactor analytics                                   | 226cc29       | Merge pull request #50 from q2-aplicaciones-web/feature/refactor-analytics | Neilcuri    | Jul 4, 2025      |
| q2-aplicaciones-web/web-app | Feature/add update products details                          | 90912a2       | Merge pull request #46 from q2-aplicaciones-web/feature/add-update-products-details | Neilcuri    | Jul 4, 2025      |
| q2-aplicaciones-web/web-app | Feature/add refactor orders                                  | d3974f5       | Merge pull request #44 from q2-aplicaciones-web/feature/add-refactor-orders | zGIKS       | Jul 3, 2025      |
| q2-aplicaciones-web/web-app | Feature/add new endpoints product catalog                    | 8b81edd       | Merge pull request #42 from q2-aplicaciones-web/feature/add-new-endpoints-product-catalog | fabriziocpa | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/add new endpoints fulfillment item                   | 81c7259       | Merge pull request #41 from q2-aplicaciones-web/feature/add-new-endpoints-fulfillment-item | zGIKS       | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/add refactor product catalog                         | b25c4bf       | refactor: Remove unused imports across multiple classes for cleaner code | zGIKS       | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/upgrade error handling                               | f4bf55a       | Merge pull request #39 from q2-aplicaciones-web/feature/upgrade-error-handling | JonatanFD   | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/refactor order processing                            | c69aed1       | Merge pull request #38 from q2-aplicaciones-web/feature/refactor-order-processing | Neilcuri    | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/add error handling                                   | a35404e       | Merge pull request #37 from q2-aplicaciones-web/feature/add-error-handling | JonatanFD   | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/add rest api endpoints                               | 0019fa7       | Merge pull request #36 from q2-aplicaciones-web/feature/add-rest-api-endpoints | zGIKS       | Jul 2, 2025      |
| q2-aplicaciones-web/web-app | Feature/add authentication                                   | 1333d8b       | Merge pull request #35 from q2-aplicaciones-web/feature/add-authentication | JonatanFD   | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Feature/add shopping cart                                    | 9cc6bcd       | Merge pull request #34 from q2-aplicaciones-web/feature/add-shopping-cart | Neilcuri    | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Feature/add cloudinary service                               | 398fe34       | Merge pull request #33 from q2-aplicaciones-web/feature/add-cloudinary-service | JonatanFD   | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Feature/add mysql dependencies                               | 398fe34       | Merge pull request #32 from q2-aplicaciones-web/feature/add-mysql-dependencies | zGIKS       | Jul 1, 2025      |
| q2-aplicaciones-web/web-app | Feature/add acl to design lab                                | 91d11bb       | Merge pull request #31 from q2-aplicaciones-web/feature/add-acl-to-design-lab | JonatanFD   | Jun 30, 2025     |
| q2-aplicaciones-web/web-app | Feature/add order processing                                 | 0043b01       | Merge pull request #30 from q2-aplicaciones-web/feature/add-order-processing | JonatanFD   | Jun 30, 2025     |
| q2-aplicaciones-web/web-app | feat: add Dockerfile for multi-stage build and application deployment | e8a93fc       | Merge pull request #28 from q2-aplicaciones-web/hotfix/add-docker-file | zGIKS       | Jun 19, 2025     |
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeN-TKrRSebt4-mjLLbXjGmhO45kL6SkwXT8RiWaKYsOLxD6VEjMnmw5P7hjIP5OosMdS8_4htYVEYJzZP1-m3mjSvsHmcK8pFFkN0Bb5mvA_o0QAE-9QVDGSocX76wXf337UFHrA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdQWYsR1767CgW5wx6D61c0XroKSjoYS1d2Irh48k_YuPrcVOEQ-jLz6UBmESlE19NliP030z2Njg28Fnzx5Nvwdfv--fZUj-ILftC6OKUzl-HGR-zye8n55EwbNOpoxXmTpzSU?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdcMPX2VEQMVCeCHKLuj7aFnrnmvnKNy-kgVnYr55F05GvPu5_khCTrhoRTLAJB1gkblWZxAvDA9wme2gijlZpoqsPke3QqH82EZaOIio3-v10imEab3qTdfR-_5qkf3Cs_tbUKyA?key=J06Wc8-GfXXlOJgmuX32uwpk)

video

#### 5.2.4.6. Services Documentation Evidence for Sprint Review

Durante el Sprint 4 del proyecto Q2 TeeLab, se avanzó significativamente en la documentación de los servicios web mediante el estándar OpenAPI 3.1. Esta documentación permite asegurar la trazabilidad, comprensión técnica y correcta integración de los endpoints desarrollados, tanto para el equipo de frontend como para el backend. La documentación fue generada y validada utilizando Swagger UI, y cubre funcionalidades clave como autenticación, gestión de proyectos, manipulación de capas, procesamiento de pedidos, y flujos de producción.
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcklUzr-U6veSV4b-eUr99FIkGxQX0gk4xIPlPtt2U8qafT_jvB7xCZqwNpilwqkzZjs2FWx_80_nVQtyFitvDIJOA_cfftFPgw8mijdigxmLUbnSM_hZiq5lPD5eYO50U5Bw1Lyw?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf7-sf_CXeTWr8ISPU7s5bTwel2AQzEPDgx4Fnbgs_HYz_4Jxa9tojQjfsx_6lzHBMWUtW2lFZqvOZGZS_jR9n8QO1GgNQ_TSbVhkhFzwEgDHeJ8vUYGsYszxYnVOUPqBk__Hi6UA?key=J06Wc8-GfXXlOJgmuX32uwpk)

El usuario accede a la página web

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXc1jgG3G5EDSLzc6CEcZJV4SrDXaxCgzBnhyinbrRNmuH-xA2WckLeBKV_yis0JmBsGi8YN8J-R7a_7T9hUxKJhBM56s0sWxeLx1EgNv-r-P_6FcD4d4VZQqDHPq-4MvvtEuxdy4g?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdUZ9OKxBC-mJGsE6ZO5Rkx6sQItd6XSA4hArvoiKgvl7SJ5espCA4LoESPETOo3DuUWY0S9b0nqRPpeSFjcUuwsMicwmU5fb146n_bacTppGsXaOSn2TjgxG6nclr0LiW-ZjFe3Q?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
Obtener detalles de un usuario ![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf_eJBKRg6V6HFaVmMOihI-svpr9UCtN0TizSAZ3GywVHC038M7LPszJ4GshbSUrEf0tNww-XadFyNqw20zyxmeUakP79kqqMLys8dG4xndZ5se3nL9vS0talitsvlRNpBXeZGalQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeTYGA_0_0nzYo2pgIW02lGwaMtHTyBV_GXWZeYyhwWl_V40uggSnT4foFlqcvVnU9zpMB3_lNfzBULSAoObCXDzmtELfIp2jKRHNnYfXaN2vJXbhcB1oOLnFHCckh7kbPeqysu?key=J06Wc8-GfXXlOJgmuX32uwpk)

Obtener detalles de un usuario 

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcudpaMp_KW9vPvECRNUpYcp_91Fj16E7iJXBTOqRTQCazjyWD_J24Jk69j1N-ViBAxaCA6GN8In2RLrNxLm6ykV4wsXAHz0JYg8devu4JA_2e6kokQMiBIEl1kP8oJAbE_9I-uQA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf8oOxl1KyV-UjS91XpZK-pvAFyCJcPgbuQ2Gje-IMfsMyUmqI6_yR750JWPIgltn8mdlsJsTgkl5CrLeuDmLX_wY8DAvuZUkgfeppPD2qQ_iUASrN_dP0OVex5KsGFJRsGzi8T?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXetiJcGgM0PYrlZy5nnreIUr_BbFuE59ddXORhDMVLv4mZtB4RDAFSHX324RSmciivYBGUDSQNOdVAxrJSYOLsFcQyI_RJ039chxhuusb3d7joCAOC9CZMJfxp4ZaWw7u31SkatPA?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXckcp4s6ykA2tkNkN5IbRuiaKcjPZhnlgkUB-LRB7K8sbBU6kmUOl1OqsVyrTipXEvvMc6TAkVJkrp1awHcC5YXodll5gTWWQdKPJcelvkba3gJqsKpgWv_aL7nnyICM1eH7T-C4A?key=J06Wc8-GfXXlOJgmuX32uwpk)

Obtener un proyecto por el id del usuario

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfWaWBApVcwttITNaLwmhiRHC7JW0xC6iOoPWKeKchtKJjUl9EA23-GZscAna1_8Us8NGMXvBXihKDHXEiXgZ_-t9bToy8J_4afi-DlydD8op-yAa6ZXGz1zbP8893KcNliJx_P?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXd3gmMr-5xCWYpHUcpJceHR-9rm_gCJvykxOs0umMz2yiqc8u-AQgYMSkhHSXPwRLJZZ1ZrrLS570HPNpQv8sLw1L1tPgG35d5Nyr0NUsxfY8fF456tZomxu2E4_bfgG-Arekv7Jw?key=J06Wc8-GfXXlOJgmuX32uwpk)

Obtener proyecto por el id del proyecto

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcynE3bFqRIhLieA0ar7mWFAESwjNC0CqRbRoHZOiZbn2A9HCxAPAQ1BLadsiyvYczy1oWGqZ4pTKey-Riw4j969JJ-ID5q74Gj7eyUgV38NyaOCbaW4h9WSO9Cxry-ZXAWj_VT7A?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXePHh63DWsuAOkc6Mx9RRwrAfcRa7g5uhJLg9lhGt9us_wJ295nDRolCqOAi_q-BCgVjenezUZcQP_Q57rO6YAdFc2AC-Xi7MgR1ruBm098mpK-olZieIuXiyQQGfQE4-aBDKfPdA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXexa1SBD9cstlluL2dIJEGZBlhPjVcoeh8J-NkJlWTG4Ri5vJDLoVUtoaoXit1yZjEdvuFLvbvBd-9B1qE_oNCYweQivh9ruIA5zEg0Vv_OoSjx0496305W0eE1Rtp6jBDn2Q3LBQ?key=J06Wc8-GfXXlOJgmuX32uwpk)

**Dar like siendo usuario a un producto**

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcH7CgjxBJX-egg_C6upsvGf9Ez38ahU06Ms2PozhvzPeSw9Kpz4JiQBhioEOlnvJmDnJllwa2JMd8Tp312DssWKtLdV9M9yKdk1wknffhFK74B7SbblYyjnlDXEmlO3j4no0i_?key=J06Wc8-GfXXlOJgmuX32uwpk)

**Obtener el número de likes de un product**

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXf-9iQhf31G3GBDd5XtxdJvGP60b7XefLxXumP4UgkveuZuvLEdh0avBlGW-gMCUygTxfVlSkgGXz2JDTJHhah4-c9XXnzI8FIP0DynpYC2bhhmP7L2nQjg1nEHkT9o8Twk3uZI?key=J06Wc8-GfXXlOJgmuX32uwpk)

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfKxIxX3TVhwazPBQ4myBTdEjgqygQwxNpOGo6c9_KXP1XClveLKV8x3hTa24f_jUAXxxmc8zAhzrwSxTU0DuFF1vq73ssJh9yAbx6rJL0mLD-UQyM0029d_SrNaWWHRfTdB2Okng?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfB8JaK--wPtwQ_1JvRiplrF4ixLDBgEJHDCRgaEtZ_56l8oeFXr3ZVzskDbp21pIpdm4f8sw25C3isH9KJLJazrTbjaZtcHMpCXkCVCMkzlziWgfPfk86Oukss9pIE3c10lx7QAA?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeUWByexLtxzRWdzutwgo_bt9nHFqZReQ0WkalkUIwN3KKIzlPiSpgC3GyV9JVXnGnFD0d-KO1bsxwc4d8kSGhcoJxvEDtEV1iYARy2s875tSL7J3Dwpkcm6wLVF8MMtx6OqH2h?key=J06Wc8-GfXXlOJgmuX32uwpk)

Evidencia de del web service

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcA8DX2Hcfo-lD-TsTD8FJzV97WjiK5dn1FDJVihuUwMWVDrotWGLEMJGRI9NSMsK_CloXeNxW4M6NnNF4kCHF1k6z_ihGnRjq98HsfS0AIqQdpz4JmzqrA1HHc9RWCx_kXn4D4?key=J06Wc8-GfXXlOJgmuX32uwpk)
...
El desarrollo del primer entregable del proyecto Q2 - TeeLab ha permitido consolidar una base metodológica, técnica y colaborativa fundamental para la evolución del producto, validando hipótesis de diseño y definiendo una visión clara de los objetivos de la plataforma. A través de la implementación estructurada de principios de ingeniería de requisitos, Lean UX y arquitectura orientada a dominios, se logró articular un ecosistema inicial funcional y coherente para la creación, personalización y exploración de camisetas digitales.
...
El Sprint 4 ha sido un claro reflejo de la madurez y cohesión de nuestro equipo, evidenciando un compromiso excepcional con el liderazgo conjunto y la creación de un entorno de trabajo altamente colaborativo e inclusivo. Se demostró un liderazgo compartido donde cada miembro guió la implementación de funcionalidades clave, asegurando que las decisiones técnicas y de diseño fueran robustas y permitiendo una asignación eficiente del trabajo y una resolución ágil de problemas. El equipo cultivó un ambiente altamente colaborativo e inclusivo, con comunicación abierta y respeto mutuo. Esto se tradujo en la capacidad de establecer metas ambiciosas pero alcanzables, planificar tareas meticulosamente y cumplir exitosamente todos los objetivos del sprint, entregando funcionalidades vitales en seguridad, gestión de pedidos y mejora de la experiencia del usuario.
...
**
****url del video**[ https://youtu.be/CUjaBBwozMo](https://youtu.be/CUjaBBwozMo)

Jonatan Acuña minuto 0:15

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeh41HbT2lgFW4dmNNcS1NCo_cKuNVTIHGchFr-uFwlKSEFj-gGJ8AxMgT_8U_J3it-vL2qfiJzJeXgdZINB7WT46zJaSkqakktPEqfuH7Lw2nNncdeO32mtX4kiI7pE2dtBOWBOg?key=J06Wc8-GfXXlOJgmuX32uwpk)

Neil Curipaco minuto 1:37

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXeBn4LN1VbM8r4gU34y06IHKgpLgK8GP_o02tdBBx5xi0ugFnaUi37vDOJVNNODqVGuPrp0_WnYuNNg_sJD3E3x8hIcpDK2W2Q0WP0ajkmXf22sxXWjsIAvrNds-h1ejnfySMci7g?key=J06Wc8-GfXXlOJgmuX32uwpk)Mateo Aleman 2:57

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfMPBfRKapzDLU2Il-3AQR7dgHhdtuHtEW1G1mZAtIor9Uhf2hOhoj8I6wz3O8mfV4tQlW1PQbZaDWWLG_RBQjr13N9fWgKJMxA0LFgtl6cAiovTLXiulo_24Gf5BQvMBedK2eSQA?key=J06Wc8-GfXXlOJgmuX32uwpk)

Fabrizio Contreras minuto 4:48

![img](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcamyaDIezVl1lu4tfQR94KifoSFAQCSg9SSa4AnnLr1rM1AWcxMXnMQnqFOWfR4sbvmtlFrbhXe8Gmx9L2-JrI39sGimj5AKWt_EkyYVkZghLsMCnYW7rX1hJYif59j4T-MDBK?key=J06Wc8-GfXXlOJgmuX32uwpk)

En este sprint, el liderazgo fue una responsabilidad compartida que emergió orgánicamente de las fortalezas individuales de cada miembro. Lejos de depender de una única figura, cada integrante asumió un rol proactivo en su área de especialización, guiando las implementaciones y asegurando que las decisiones técnicas y de diseño fueran robustas. Esta aproximación descentralizada al liderazgo facilitó una asignación de trabajo eficiente y una resolución de problemas más ágil, lo que se tradujo en un progreso constante y de alta calidad para la Web Service y la Web App.

Además, el equipo cultivó con éxito un ambiente de trabajo altamente colaborativo e inclusivo, donde cada voz fue valorada y la comunicación abierta fue clave. Demostramos una gran habilidad para establecer metas ambiciosas pero alcanzables durante la planificación del sprint. Estas metas se desglosaron en tareas manejables, y la ejecución coordinada y el apoyo mutuo entre los miembros fueron fundamentales. Este enfoque no solo optimizó nuestro proceso de desarrollo, sino que también fortaleció la cohesión del equipo y nos permitió cumplir exitosamente todos los objetivos del sprint, entregando funcionalidades clave en seguridad, gestión de pedidos y mejora de la experiencia del usuario.

En síntesis, este Sprint ha sido un testimonio de la sinergia y la capacidad técnica del equipo, logrando implementar funcionalidades críticas que enriquecen significativamente la experiencia del usuario final y optimizan los procesos para los fabricantes. La seguridad, la eficiencia del flujo de compra y la gestión operativa fueron los pilares de nuestro trabajo, y todo ello fue posible gracias a una comunicación excepcional que garantizó la cohesión y el avance continuo del proyecto.
